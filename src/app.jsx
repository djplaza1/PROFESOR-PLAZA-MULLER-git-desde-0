...
function App() {
  ...
  return (
    <div id="app-main" style={{ fontFamily: 'Outfit, sans-serif', background: '#0f172a', color: '#e2e8f0', height: '100vh', display: 'flex', flexDirection: 'column' }}>
      {warmLight > 0 && React.createElement('div', { style: { position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 999, background: "rgba(255, 200, 100, )", mixBlendMode: 'lighten', transition: 'background 0.5s' } })}
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0f172a' }}>
      <form onSubmit={handleSubmit} style={{ background: '#1e293b', padding: 32, borderRadius: 16, border: '1px solid #334155', width: 360 }}>
        <h2 style={{ color: '#e2e8f0', marginBottom: 24, fontSize: '1.5rem', fontWeight: 700 }}>{mode === 'login' ? 'Iniciar sesión' : 'Crear cuenta'}</h2>
