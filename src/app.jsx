...
function App() {
  ...
  return (
    <div id="app-main" style={{ position: "relative", filter: theme === 'light' ? 'sepia(0.6) hue-rotate(-5deg) brightness(1.05)' : 'none', fontFamily: 'Outfit, sans-serif', background: '#0f172a', color: '#e2e8f0', height: '100vh', display: 'flex', flexDirection: 'column' }}>
