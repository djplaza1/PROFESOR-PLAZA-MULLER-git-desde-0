...
addLevel('A1.2',[
  ...
  ['Konzern','grupo empresarial','der','Konzerne','n'],
    ['Wettervorhersage','pronóstico del tiempo','die','Wettervorhersagen','n'],
  ['Seil','cuerda','das','Seile','n'],
    ['Feiertag','día festivo','der','Feiertage','n'],
  ...
  ['August','agosto','der','','n'],
    ...
    ['Lachs','salmón','der','Lachse','n'],
    ['Nuss','nuez','die','Nüsse','n'],
    ['aufheben','recoger','','','v'],
        ['Limonade','limonada','die','Limonaden','n'],
    ['Lampe','lámpara','die','Lampen','n'],
  ['Ausflug','excursión','der','Ausflüge','n'],
    ['scannen','escanear','-','-','v'],
  ['dämpfen','cocinar al vapor','','','v'],
    ['Thunfisch','atún','der','Thunfische','n'],
  ['seit','desde','','','prep'],
  ...
  ['hinlegen','tumbar','','','v'],
  ['statt','en lugar de','','','prep'],
  ['Nachtschicht','turno de noche','die','Nachtschichten','n'],
    ['Garten','jardín','der','Gärten','n'],
  ...
  ['Oma','abuela','die','Omas','n'],
    ['Mittag','mediodía','der','Mittage','n'],
  ['Stall','establo','der','Ställe','n'],
    ['richten','dirigir','','','v'],
    ['Heizung','calefacción','die','Heizungen','n'],
  ...
  ['hinter','detrás de','','','prep'],
    ['zwanzig','veinte','','','num'],
  ['Zentimeter','centímetro','der','Zentimeter','n'],
  ...
  ['Elefant','elefante','der','Elefanten','n'],
    ['ergeben','resultar','','','v'],
  ['Bleistift','lápiz','der','Bleistifte','n'],
  ['Kreide','tiza','die','-','n'],
  ['Puls','pulso','der','Pulse','n'],
  ['Abteil','compartimento','das','Abteile','n'],
  ...
  ['abgießen','escurrir','','','v'],
    ['weihen','consagrar','','','v'],
  ['Informatiker','informático','der','Informatiker','n'],
  ...
  ['Wohnzimmer','salón','das','Wohnzimmer','n'],
  ...
  ['Bad','baño','das','Bäder','n'],
    ...
    ['Blaubeere','arándano','die','Blaubeeren','n'],
    ['werten','valorar','','','v'],
  ['unter','[unter]','','','n'],
...
addLevel('A2.1',[
  ...
  ['Waschraum','el lavadero / cuarto de aseo','der','','n'],
    ['Mathe','matemáticas','die','Mathen','n'],
  ...
  ['Vermutung','la suposición','die','','n'],
    ['Biologie','biología','die','Biologien','n'],
...
addLevel('A2.2',[
  ...
  ['sich kümmern um','ocuparse de','','','v']','','','n'],
  ...
  ['Gedächtnis','memoria','das','Gedächtnisse','n']','','','n'],
    ['Bluthochdruck','hipertensión','der','-','n']','die','Bluthochdrucken','n'],
  ...
  ['versöhnen','reconciliarse','','','v'],['vermuten','suponer','','','v'],
    ['Signal','señal','das','Signale','n']','das','Signalen','n'],
  ...
  ['verwalten','administrar','','','v'],
    ...
    ['Telefon','teléfono','das','Telefone','n']','die','Telefonen','n'],
  ...
  ['Hausratversicherung','seguro de hogar','die','Hausratversicherungen','n'],
    ...
    ['Schuhladen','zapatería','der','Schuhläden','n']','der','Schuhladen','n'],
    ['Blumenladen','floristería','der','Blumenläden','n']','das','Blumenladen','n'],
  ...
  ['Petition','petición','die','Petitionen','n'],
    ['Reha','rehabilitación','die','Rehas','n']','das','Rehaen','n'],
  ...
  ['peinlich','vergonzoso','','','adj'],
    ...
    ['Wettkampf','competición','der','Wettkämpfe','n'],
  ...
  ['sich freuen über','alegrarse de','','','v']','','','n'],
  ...
  ['sich interessieren für','interesarse por','','','v']','','','n'],
  ['fühlen','sentir','','','v'],
  ...
  ['Vermietung','el alquiler (acción)','die','','n'],
    ...
    ['Entzündung','inflamación','die','Entzündungen','n']','die','Entzündungen','n'],
  ...
  ['Schaf','la oveja','das','','n'],
    ...
    ['Spritze','inyección','die','Spritzen','n']','der','Spritzen','n'],
  ...
  ['sich bedanken für','agradecer por','','','v']','','','n'],
  ...
  ['Schluss','el final / conclusión','der','','n'],
    ['Mailbox','buzón de voz','die','Mailboxen','n']','der','Mailboxen','n'],
  ...
  ['bestehen','aprobar/superar','','','v'],['durchfallen','suspender','','','v'],
    ['Baumarkt','ferretería','der','Baumärkte','n']','das','Baumarkten','n'],
  ...
  ['Pflegeversicherung','seguro de dependencia','die','Pflegeversicherungen','n'],
    ['Untersuchung','revisión','die','Untersuchungen','n']','die','Untersuchungen','n'],
  ...
  ['ehrlich','honesto','','','adj'],['mutig','valiente','','','adj'],
    ...
    ['Klingelton','tono de llamada','der','Klingeltöne','n']','die','Klingeltonen','n'],
    ['Parallele','paralelo','die','Parallelen','n'],
  ['Rotkäppchen','Caperucita Roja','das','-','n']','','','n'],
  ...
  ['Ausländerbehörde','oficina de extranjería','die','Ausländerbehörden','n'],
    ...
    ['Cent','céntimo','der','Cent','n']','das','Centen','n'],
  ...
  ['Humor','el humor','der','','n'],
    ...
    ['Medikament','medicamento','das','Medikamente','n']','das','Medikamenten','n'],
  ['umziehen','mudarse','','','v'],
  ...
  ['Schlag','el golpe','der','','n'],
    ['Handynummer','número de móvil','die','Handynummern','n']','der','Handynummer','n'],
  ...
  ['Kamera','cámara','die','Kameras','n'],['Handy','móvil','das','Handys','n'],
    ...
    ['Einkauf','compra','der','Einkäufe','n']','die','Einkaufen','n'],
...
addLevel('B1.1',[
  ...
  ['Hochschule','la universidad / escuela superior','die','','n'],
    ['Deadline','fecha límite','die','Deadlines','n']','die','Deadlinen','n'],
  ...
  ['der Vertrag','el contrato','der','Verträge','n'],
    ...
    ['Vorstellungsgespräch','entrevista','das','Vorstellungsgespräche','n']','die','Vorstellungsgesprächen','n'],
    ['bevölkern','poblar','','','v'],
  ...
  ['Aktion','la acción / la campaña','die','','n'],
    ['Büro','oficina','das','Büros','n']','die','Büroen','n'],
  ...
  ['sprechen über','hablar sobre','','','v']','','','n'],
  ...
  ['Eis','el helado / hielo','das','','n'],
    ['Präsentation','presentación','die','Präsentationen','n']','die','Präsentationen','n'],
  ...
  ['sich beschweren über','quejarse de','','','v']','','','n'],
  ...
  ['der Ausweis','el documento','der','Ausweise','n'],
    ...
    ['Abteilung','departamento','die','Abteilungen','n']','die','Abteilungen','n'],
  ...
  ['der Arbeitgeber','el empleador','der','Arbeitgeber','n'],
    ['Meeting','reunión','das','Meetings','n']','der','Meetingen','n'],
...
addLevel('B1.2',[
  ...
  ['erlauben','permitir','','','v'],
    ['Naturschutz','protección de la naturaleza','der','-','n']','das','Naturschutzen','n'],
  ...
  ['sich verändern','cambiar','','','v'],
    ['Mehrfamilienhaus','bloque de pisos','das','Mehrfamilienhäuser','n']','der','Mehrfamilienhausen','n'],
  ['harmonisch','armonioso','','','adj']','','','adj'],
    ['See','lago','der','Seen','n']','das','Seen','n'],
    ['weiterarbeiten','seguir trabajando','','','v'],
    ['der Hals','cuello','der','Hälse','n'],
    ['Kopfhörer','auriculares','der','Kopfhörer','n']','der','Kopfhörer','n'],
  ...
  ['verhandeln','negociar','','','v'],
    ...
    ['Artenschutz','protección de especies','der','-','n']','die','Artenschutzen','n'],
  ...
  ['umfassen','abarcar','','','v'],['einschließen','incluir','','','v'],
    ['Energie','energía','die','Energien','n']','die','Energien','n'],
  ...
  ['zunächst','primero','','','adv'],
    ...
    ['Klimawandel','cambio climático','der','-','n']','das','Klimawandel','n'],
  ...
  ['jeweils','respectivamente','','','adv'],
    ['Windkraft','energía eólica','die','-','n']','die','Windkraften','n'],
  ...
  ['Fertigkeit','destreza','die','Fertigkeiten','n'],
    ['Passwort','contraseña','das','Passwörter','n']','die','Passworten','n'],
  ...
  ['beschließen','decidir','','','v'],['vereinbaren','acordar','','','v'],
    ...
    ['Reihenhaus','casa adosada','das','Reihenhäuser','n']','der','Reihenhausen','n'],
  ['nachher','después','','','adv'],
  ...
  ['Leben','la vida','das','','n'],
    ...
    ['Wasserkraft','energía hidráulica','die','-','n']','die','Wasserkraften','n'],
  ...
  ['Ursache','causa','die','Ursachen','n'],['Wirkung','efecto','die','Wirkungen','n'],
    ...
    ['E-Mail','correo electrónico','die','E-Mails','n']','das','EMailen','n'],
  ...
  ['daher','por ello','','','adv'],
    ...
    ['Einfamilienhaus','casa unifamiliar','das','Einfamilienhäuser','n']','der','Einfamilienhausen','n'],
  ...
  ['bereits','ya','','','adv'],
    ...
    ['Abfalltrennung','separación de residuos','die','-','n']','die','Abfalltrennungen','n'],
    ['Müllverbrennung','incineración de residuos','die','-','n']','die','Müllverbrennungen','n'],
  ['damals','entonces','','','adv'],
  ['Künstler','artista','der','Künstler','n']','','','n'],
    ['korrigieren','corregir','-','-','v'],
    ['die Datei','archivo','die','Dateien','n'],
  ['gehören zu','pertenecer a','','','v']','','','n'],
  ...
  ['Abitur','la selectividad','das','','n'],
    ...
    ['Smartphone','teléfono inteligente','das','Smartphones','n']','der','Smartphonen','n'],
  ...
  ['sich gewöhnen an','acostumbrarse a','','','v']','','','n'],
  ['sich fürchten vor','temer a','','','v']','','','n'],
  ...
  ['Einfluss','influencia','der','Einflüsse','n']','','','n'],
  ...
  ['abhängen von','depender de','','','v']','','','n'],
    ['biologisch','biológico','','','adj']','der','biologischen','n'],
  ...
  ['willkommen','bienvenido','','','adj'],['beliebt','popular','','','adj'],
    ...
    ['giftig','tóxico','','','adj']','der','giftigen','n'],
  ['Gesellschaft','sociedad','die','Gesellschaften','n'],['Umwelt','medio ambiente','die','Umwelten','n'],
    ...
    ['erwärmen','calentar','','','v']','die','erwärmen','n'],
  ...
  ['hervorgehen','desprenderse','','','v'],['zurückführen','atribuir','','','v'],
    ['Wald','bosque','der','Wälder','n']','die','Walden','n'],
  ...
  ['ausschließen','excluir','','','v'],['enthalten','contener','','','v'],
    ...
    ['Anhang','archivo adjunto','der','Anhänge','n']','das','Anhangen','n'],
  ...
  ['Jahrhundert','el siglo','das','','n'],
    ...
    ['Busfahrt','viaje en autobús','die','Busfahrten','n']','das','Busfahrten','n'],
  ...
  ['Misserfolg','fracaso','der','Misserfolge','n'],
    ...
    ['Solaranlage','instalación solar','die','Solaranlagen','n']','die','Solaren','n'],
  ...
  ['abstimmen','votar','','','v'],['zuhören','escuchar','','','v'],
    ['Wasserverschmutzung','contaminación del agua','die','-','n']','die','Wasserverschmutzungen','n'],
  ...
  ['sich unterhalten','conversar','','','v'],
    ...
    ['Ökologie','ecología','die','-','n']','die','Ökologien','n'],
  ...
  ['Verbindung','la conexión','die','','n'],
    ...
    ['Mikrofon','micrófono','das','Mikrofone','n']','die','Mikrofonen','n'],
    ['der Ellenbogen','codo','der','Ellenbogen','n'],
    ['Fähre','ferry','die','Fähren','n']','der','Fähren','n'],
  ...
  ['führen','conducir','','','v'],['resultieren','resultar','','','v'],
    ['Hochhaus','rascacielos','das','Hochhäuser','n']','der','Hochhausen','n'],
  ...
  ['Frieden','paz','der','','n'],['Krieg','guerra','der','Kriege','n'],
    ['Ökostrom','electricidad verde','der','-','n']','der','Ökostromen','n'],
  ...
  ['sich verhalten','comportarse','','','v'],
    ...
    ['Sanierung','rehabilitación','die','Sanierungen','n']','die','Sanierungen','n'],
  ['schützen vor','proteger de','','','v']','','','n'],
  ...
  ['vorher','antes','','','adv'],
    ...
    ['Einbauküche','cocina equipada','die','Einbauküchen','n']','das','Einbauküchen','n'],
  ...
  ['sich entscheiden für','decidirse por','','','v']','','','n'],
  ...
  ['Ausländer','extranjero','der','Ausländer','n'],['Flüchtling','refugiado','der','Flüchtlinge','n'],
    ['Kohlendioxid','dióxido de carbono','das','-','n']','der','Kohlendioxiden','n'],
    ['ablehnen','rechazar','-','-','v'],
  ...
  ['unwahrscheinlich','improbable','','','adj'],['erforderlich','requerido','','','adj'],
    ...
    ['App','aplicación','die','Apps','n']','das','Appen','n'],
  ...
  ['leiden unter','sufrir de','','','v']','','','n'],
    ...
    ['Küchenzeile','cocina americana','die','Küchenzeilen','n']','das','Küchenzeilen','n'],
    ['das Wasser','agua','das','Wasser','n'],
    ['Abfall','residuo','der','Abfälle','n']','das','Abfallen','n'],
  ['zuerst','primero','','','adv'],
