...
// Palabras íºnicas deduplicadas: primera aparición tiene prioridad
(function(R) {
...
addLevel('A1.1',[
  ...
  ['grob','grueso','','','adj'],
  ['Apfel','manzana','der','í„pfel','n'],['Bier','cerveza','das','Biere','n'],
  ...
  ['Name','nombre','der','Namen','n'],['Tag','dí­a','der','Tage','n'],
  ...
  ['Kissen','la almohada / cojí­n','das','','n'],
  ...
  ['Auskunft','la información','die','','n'],
    ['Regenbogen','arcoí­ris','der','Regenbogen','n'],
  ...
  ['Nichte','la sobrina','die','','n'],
    ['purpur','píºrpura','die','purpuren','n'],
  ['Rose','la rosa','die','','n'],
  ['seltsam','extraño','','','adj'],
  ['Baum','el árbol','der','','n'],
  ...
  ['Reiseführer','la guí­a de viaje','der','','n'],
  ['difficult','difí­cil','','','n'],
    ['golden','dorado','-','-','adj'],
  ...
  ['ernst','serio','','','adj'],
  ['erst','sólo','','','adv'],
    ['die Tante','tí­a','die','Tanten','n'],
  ['locker','suelto','','','adj'],
      ['Freund','amigo','der','Freunde','n'],
  ['Juni','el junio','der','','n'],
  ['Kugelschreiber','el bolí­grafo','der','','n'],
  ...
  ['S-Bahn','el tren de cercaní­as','die','','n'],
...
addLevel('A1.2',[
  ...
  ['Fluss','rí­o','der','Flüsse','n'],['See','lago','der','Seen','n'],
  ...
  ['schwer','pesado/difí­cil','','','adj'],['leicht','ligero/fácil','','','adj'],
  ...
  ['Rasen','césped','der','Rasen','n'],
    ['die Buchhandlung','librerí­a','die','Buchhandlungen','n'],
  ['Giraffe','jirafa','die','Giraffen','n'],
  ['Muskel','míºsculo','der','Muskeln','n'],
  ...
  ['Seil','cuerda','das','Seile','n'],
    ['Feiertag','dí­a festivo','der','Feiertage','n'],
  ...
  ['öffnen','abrir','','','v'],
    ['Wassermelone','sandí­a','die','Wassermelonen','n'],
  ...
  ['Strumpf','calcetí­n','der','Strümpfe','n'],
    ['Schlafanzug','pijama','der','Schlafanzüge','n'],
    ['Weisheit','sabidurí­a','die','Weisheiten','n'],
  ...
  ['Familie','familia','die','Familien','n'],['Freund','amigo','der','Freunde','n'],
    ...
    ['Shampoo','champíº','das','Shampoos','n'],
  ...
  ['dämpfen','cocinar al vapor','','','v'],
    ['Thunfisch','atíºn','der','Thunfische','n'],
  ['seit','desde','','','prep'],
  ...
  ['Einbahnstraße','dirección íºnica','die','Einbahnstraßen','n'],
  ...
  ['ausrutschen','resbalarse','','','v'],
    ['Eule','bíºho','die','Eulen','n'],
  ['Supermarkt','supermercado','der','Supermärkte','n'],['Bäcker','panaderí­a','der','Bäcker','n'],
  ...
  ['Polizeiwache','comisarí­a','die','Polizeiwachen','n'],
    ['Tag','dí­a','der','Tage','n'],
    ['Bauch','barriga','der','Bäuche','n'],
  ['Oma','abuela','die','Omas','n'],
    ['Mittag','mediodí­a','der','Mittage','n'],
  ...
  ['Zahnpasta','pasta dentí­frica','die','Zahnpasten','n'],
  ['Armband','pulsera','das','Armbänder','n'],
  ...
  ['íœberstunde','hora extra','die','íœberstunden','n'],
  ...
  ['Turnhalle','gimnasio','die','Turnhallen','n'],
      ['Tau','rocí­o','der','Taue','n'],
  
    ['Minute','minuto','die','Minuten','n'],
    ['Spinne','araña','die','Spinnen','n'],
  ['Land','paí­s','das','Länder','n'],['Straße','calle','die','Straßen','n'],
  ...
  ['Wäscherei','lavanderí­a','die','Wäschereien','n'],
  ...
  ['spülen','enjuagar','','','v'],
  ['Café','cafeterí­a','das','Cafés','n'],['Kino','cine','das','Kinos','n'],
  ...
  ['Sozialversicherung','seguridad social','die','Sozialversicherungen','n'],
    ['der Apfel','manzana','der','í„pfel','n'],
  ...
  ['Fleischer','carnicerí­a','der','Fleischer','n'],['Restaurant','restaurante','das','Restaurants','n'],
  ...
  ['Arzt','médico','der','í„rzte','n'],['Krankenhaus','hospital','das','Krankenhäuser','n'],
  ...
  ['kehren','barrer','','','v'],
    ['der Mittag','mediodí­a','der','Mittage','n'],
  ...
  ['Metzgerei','la carnicerí­a','die','','n'],
  ...
  ['Krankheitstag','dí­a de enfermedad','der','Krankheitstage','n'],
  ...
  ['wegräumen','guardar','','','v'],
    ['betrügen','engañar','','','v'],
  ['Zucker','azíºcar','der','','n'],['Salz','sal','das','','n'],
  ...
  ['Darm','intestino','der','Därme','n'],
    ['der Eistee','té frí­o','der','Eistees','n'],
  ...
  ['Notiz','la nota / apunte','die','','n'],
    ['der Delfin','delfí­n','der','Delfine','n'],
  ...
  ['Metzger','carnicerí­a','der','Metzger','n'],
...
addLevel('A2.1',[
  ...
  ['Lücke','el hueco / vací­o','die','','n'],
    ['ärgern','molestar','-','-','v'],
  ['Kritik','la crí­tica','die','','n'],
  ['vermieten','alquilar','','','v'],['wechseln','cambiar','','','v'],
    ['íœbersetzung','traducción','die','íœbersetzungen','n'],
  ...
  ['irgendwo','en algíºn lugar','','','adv'],['zusammen','juntos','','','adv'],
    ['setzen','poner','','','v'],
  ...
  ['Streik','la huelga','der','','n'],
    ['der Kugelschreiber','bolí­grafo','der','Kugelschreiber','n'],
  ...
  ['Enkel','el nieto','der','','n'],
    ['fallen','caer','-','-','v'],
  ['Leitung','la dirección / tuberí­a / lí­nea','die','','n'],
  ...
  ['Kennzeichen','la matrí­cula / señal','das','','n'],
  ...
  ['Buchhandlung','la librerí­a','die','','n'],
    ['tippen','teclear','','','v'],
  ...
  ['Vermutung','la suposición','die','','n'],
    ['Biologie','biologí­a','die','Biologien','n'],
...
addLevel('A2.2',[
  ...
  ['Tor','la puerta grande / porterí­a / gol','das','','n'],
  ...
  ['Ansage','el anuncio (por megafoní­a)','die','','n'],
    ['Entführung','secuestro','die','Entführungen','n'],
    ['í–ffnung','apertura','die','í–ffnungen','n'],
  ...
  ['Tarifvertrag','convenio colectivo','der','Tarifverträge','n'],
    ['die Polizistin','policí­a','die','Polizistinnen','n'],
  ...
  ['entschuldigen','disculpar','','','v'],['verzeihen','perdonar','','','v'],
    ...
    ['die íœbersetzerin','traductora','die','íœbersetzerinnen','n'],
    ['das Turnen','gimnasia artí­stica','das','Turnen','n'],
  ['Reifen','el neumático','der','','n'],
    ['í–konomie','economí­a','die','í–konomien','n'],
  ...
  ['Freiwilligenarbeit','trabajo voluntario','die','-','n'],
    ...
    ['der íœbersetzer','traductor','der','íœbersetzer','n'],
    ['Gruppenarbeit','trabajo en grupo','die','','n'],
    ['sich erkundigen','informarse','','','v'],
  ['sich freuen','alegrarse','','','v'],['sich fürchten','temer','','','v'],
    ['Bar','bar','die','Bars','n'],
  ['Wandertag','el dí­a de senderismo','der','','n'],
    ['beispielsweise','por ejemplo','','','adv'],
  ['Akku','baterí­a','der','Akkus','n'],['Ladekabel','cable carga','das','Ladekabel','n'],
  ...
  ['íœbung','el ejercicio','die','','n'],
  ['Probezeit','perí­odo de prueba','die','Probezeiten','n'],
    ['der Fußball','fíºtbol','der','Fußbälle','n'],
  ...
  ['Angst','miedo','die','í„ngste','n'],['Wut','ira','die','','n'],
  ...
  ['Nähe','la cercaní­a / proximidad','die','','n'],
  ...
  ['Hausratversicherung','seguro de hogar','die','Hausratversicherungen','n'],
    ...
    ['Schuhladen','zapaterí­a','der','Schuhläden','n'],
    ['Blumenladen','floristerí­a','der','Blumenläden','n'],
  ...
  ['anziehen','vestirse','','','v'],
    ...
    ['Myriade','mirí­ada','die','Myriaden','n'],
  ['Rechtsschutzversicherung','seguro de defensa jurí­dica','die','Rechtsschutzversicherungen','n'],
  ...
  ['Rezept','receta médica','das','Rezepte','n'],['Untersuchung','revisión','die','Untersuchungen','n'],
    ['die Polizei','policí­a','die','Polizeien','n'],
  ['Bürgerinitiative','iniciativa ciudadana','die','Bürgerinitiativen','n'],
    ['der Bus','autobíºs','der','Busse','n'],
  ...
  ['Schlaf','el sueño (acto de dormir)','der','','n'],
    ...
    ['die Metzgerei','carnicerí­a','die','Metzgereien','n'],
  ...
  ['í„rztin','médica','die','í„rztinnen','n'],
  ...
  ['Zeichen','la señal / signo / sí­mbolo','das','','n'],
    ['Fieber','fiebre','das','-','n'],
  ...
  ['bestehen','aprobar/superar','','','v'],['durchfallen','suspender','','','v'],
    ['Baumarkt','ferreterí­a','der','Baumärkte','n'],
  ...
  ['Juwelier','joyerí­a','der','Juweliere','n'],
  ...
  ['Gefühl','sentimiento','das','Gefühle','n'],['Freude','alegrí­a','die','Freuden','n'],
  ['Fett','la grasa','das','','n'],
  ...
  ['erinnern','recordar','','','v'],
    ...
    ['der BotanischerGarten','jardí­n botánico','der','BotanischeGärten','n'],
  ...
  ['tauschen','intercambiar','','','v'],['anprobieren','probarse','','','v'],
    ...
    ['Dichtung','poesí­a','die','Dichtungen','n'],
  ...
  ['Ausländerbehörde','oficina de extranjerí­a','die','Ausländerbehörden','n'],
  ...
  ['Fernbus','autobíºs de larga distancia','der','Fernbusse','n'],
  ['Dank','el agradecimiento','der','','n'],
  ['schmal','estrecho','','','adj'],
  ['Opfer','la ví­ctima','das','','n'],
  ...
  ['Adresse','dirección','die','Adressen','n'],['Telefonnummer','níºmero teléfono','die','Telefonnummern','n'],
  ...
  ['gerecht','justo','','','adj'],
    ['der Kindergarten','guarderí­a','der','Kindergärten','n'],
  ...
  ['Mindestlohn','salario mí­nimo','der','-','n'],
  ...
  ['Schlag','el golpe','der','','n'],
    ['Handynummer','níºmero de móvil','die','Handynummern','n'],
  ...
  ['Kamera','cámara','die','Kameras','n'],['Handy','móvil','das','Handys','n'],
    ['die Bäckerei','panaderí­a','die','Bäckereien','n'],
  ...
  ['Hypothek','hipoteca','die','Hypotheken','n'],
    ...
    ['Lärmbelästigung','contaminación acíºstica','die','Lärmbelästigungen','n'],
  ...
  ['Mahlzeit','la comida (del dí­a)','die','','n'],
  ...
  ['Anschluss','la conexión (transporte/teléfono)','der','','n'],
    ...
    ['Parfümerie','perfumerí­a','die','Parfümerien','n'],
  ...
  ['Region','la región','die','','n'],
    ...
    ['das Tor','porterí­a/gol','das','Tore','n'],
  ...
  ['Teilnehmer','el participante','der','','n'],
    ['der Polizist','policí­a','der','Polizisten','n'],
...
addLevel('B1.1',[
  ...
  ['Hochschule','la universidad / escuela superior','die','','n'],
    ['Deadline','fecha lí­mite','die','Deadlines','n'],
  ...
  ['Störung','la molestia / la averí­a','die','','n'],
  ...
  ['Vernunft','la razón / el sentido comíºn','die','','n'],
  ['weil','porque','','','conj'],['obwohl','aunque','','','conj'],
  ['erlaubt','permitido','','','adj'],
  ['Täter','el autor (delito)','der','','n'],
    ['die íœberstunde','hora extra','die','íœberstunden','n'],
  ['Monat','el mes','der','','n'],
  ['Abschluss','tí­tulo','der','Abschlüsse','n'],['Stipendium','beca','das','Stipendien','n'],
  ...
  ['Garantie','la garantí­a','die','','n'],
  ['Lebenslauf','el currí­culum','der','','n'],
  ...
  ['Stift','el bolí­grafo / el lápiz','der','','n'],
    ['einhalten','cumplir','','','v'],
  ['unglaublich','increí­ble','','','adj'],
  ...
  ['Dienst','servicio/turno','der','Dienste','n'],
    ['der Lebenslauf','currí­culum','der','Lebensläufe','n'],
  ...
  ['Dusche','la ducha','die','','n'],
    ['kleinschreiben','escribir con miníºscula','','','v'],
  ...
  ['Phantasie','la fantasí­a / la imaginación','die','','n'],
    ['egal','igual','-','-','adj'],
  ...
  ['Bauer','el campesino','der','','n'],
    ['großschreiben','escribir con mayíºscula','','','v'],
  ...
  ['Sekretariat','la secretarí­a','das','','n'],
  ...
  ['Bohne','la alubia / judí­a','die','','n'],
  ['Ausfahrt','la salida (autoví­a)','die','','n'],
  ['Held','el héroe','der','','n'],
...
addLevel('B1.2',[
  ...
  ['hoffentlich','ojalá','','','adv'],
    ['weglassen','omitir','','','v'],
  ['Politik','polí­tica','die','Politiken','n'],['Regierung','gobierno','die','Regierungen','n'],
  ...
  ['für','para','','','prp'],
    ...
    ['der Regenbogen','arcoí­ris','der','Regenbogen','n'],
  ...
  ['Bewegung','ejercicio','die','Bewegungen','n'],['Sportart','deporte','der','Sportarten','n'],
    ['der í–kostrom','electricidad verde','der','í–koströme','n'],
  ...
  ['Geburtstag','cumpleaños','der','Geburtstage','n'],['Hochzeit','boda','die','Hochzeiten','n'],
    ...
    ['die Leber','hí­gado','die','Lebern','n'],
  ...
  ['umfassen','abarcar','','','v'],['einschließen','incluir','','','v'],
    ['Energie','energí­a','die','Energien','n'],
  ...
  ['trainieren','entrenar','','','v'],['gewinnen','ganar','','','v'],
    ['umkommen','morir','','','v'],
  ['Wohnungssuche','bíºsqueda de piso','die','-','n'],
  ...
  ['zunächst','primero','','','adv'],
    ...
    ['Windkraft','energí­a eólica','die','-','n'],
  ...
  ['Leben','la vida','das','','n'],
    ...
    ['Wasserkraft','energí­a hidráulica','die','-','n'],
  ...
  ['Ursache','causa','die','Ursachen','n'],['Wirkung','efecto','die','Wirkungen','n'],
    ...
    ['größtenteils','en su mayorí­a','-','-','adv'],
  ...
  ['Skulptur','escultura','die','Skulpturen','n'],
    ...
    ['das Regal','estanterí­a','das','Regale','n'],
  ...
  ['plötzlich','de repente','','','adv'],
    ['das Kissen','cojí­n','das','Kissen','n'],
  ...
  ['Anleitung','la instrucción / guí­a','die','','n'],
  ...
  ['Silvester','Nochevieja','das','','n'],['Karneval','carnaval','der','Karnevale','n'],
    ...
    ['der Muskel','míºsculo','der','Muskeln','n'],
  ...
  ['Identität','la identidad','die','','n'],
    ...
    ['das Ohr','oí­do/oreja','das','Ohren','n'],
  ...
  ['Jahrhundert','el siglo','das','','n'],
    ...
    ['Busfahrt','viaje en autobíºs','die','Busfahrten','n'],
  ...
  ['verlangen','exigir','','','v'],['fordern','demandar','','','v'],
    ...
    ['die í„rztin','médica','die','í„rztinnen','n'],
  ...
  ['sich unterhalten','conversar','','','v'],
    ...
    ['í–kologie','ecologí­a','die','-','n'],
  ['Brauch','costumbre','der','Bräuche','n'],['Feiertag','dí­a festivo','der','Feiertage','n'],
  ...
  ['Weihnachten','Navidad','das','','n'],['Ostern','Pascua','das','','n'],
    [],
    ['die Energie','energí­a','die','Energien','n'],
  ...
  ['exakt','exacto','','','adj'],['präzise','preciso','','','adj'],
    ...
    ['keineswegs','de ningíºn modo','-','-','adv'],
  ...
  ['Frieden','paz','der','','n'],['Krieg','guerra','der','Kriege','n'],
    ['í–kostrom','electricidad verde','der','-','n'],
    ['weiterreichen','pasar','','','v'],
    ['die Ferne','lejaní­a','die','Fernen','n'],
  ...
  ['zuletzt','por íºltimo','','','adv'],
    ['die Kälte','frí­o','die','Kälten','n'],
  ...
  ['zuerst','primero','','','adv'],
    ['die Nähe','cercaní­a','die','Nähen','n'],
    ['nahe','cerca de','-','-','prp'],
  ...
  ['Publikum','píºblico','das','Publikums','n'],['Zuschauer','espectador','der','Zuschauer','n'],
]);

addLevel('B2.1',[
  ['Hierarchie','la jerarquí­a','die','','n'],
  ['Umfeld','el entorno / ambiente','das','','n'],
  ['Verfassung','la constitución','die','','n'],
  ['íœberschneidung','el solapamiento','die','','n'],
  ...
  ['Bindung','el ví­nculo / lazo','die','','n'],
  ...
  ['Rechtsvorschrift','la norma jurí­dica','die','','n'],
  ...
  ['Registrierung','el registro','die','','n'],
    ['el Pí­xel','el pí­xel','','','n'],
  ['Windenergie','energí­a eólica','die','','n'],['Kernkraft','energí­a nuclear','die','Kernkräfte','n'],
  ...
  ['í–ffnungszeit','el horario de apertura','die','','n'],
    [],
  ['Nachweis','la prueba / el justificante','der','','n'],
  ['Zusage','la confirmación','die','','n'],
  ['Ressource','recurso','die','Ressourcen','n'],['Energie','energí­a','die','Energien','n'],
  ['íœberlegung','la reflexión','die','','n'],
  ['Grenzwert','el valor lí­mite','der','','n'],
    [],
  ...
  ['íœberzeugung','la convicción','die','','n'],
  ...
  ['Haltung','la postura / actitud','die','','n'],
    ...
    ['íœberweisung','transferencia','die','íœberweisungen','n'],
  ['Lesung','la lectura píºblica','die','','n'],
  ...
  ['Erneuerbare','renovables','die','','n'],['Solarenergie','energí­a solar','die','','n'],
  ...
  ['Philosophie','la filosofí­a','die','Philosophien','n'],
  ...
  ['Reiz','el estí­mulo / atractivo','der','','n'],
...
addLevel('B2.2',[
  ...
  ['Nation','la nación','die','','n'],
    [],
  ['Alltag','dí­a a dí­a','der','','n'],['Routine','rutina','die','Routinen','n'],
  ...
  ['íœbermacht','la superioridad','die','','n'],
  ...
  ['Dosierung','la dosificación','die','','n'],
    ['die Monarchie','monarquí­a','die','Monarchien','n'],
  ...
  ['Technik','técnica','die','Techniken','n'],['Technologie','tecnologí­a','die','Technologien','n'],
  ['Sonderregelung','la regulación especial','die','','n'],
  ['Pädagogik','la pedagogí­a','die','','n'],
    [],
  ...
  ['íœberweisung','la transferencia','die','','n'],
  ['Psicologí­a','la psicologí­a','la','','n'],
  ...
  ['Akustik','la acíºstica','die','','n'],
  ['unübertroffen','insuperable','','','adj'],
  ['Minimum','el mí­nimo','das','','n'],
  ...
  ['Beute','el botí­n / la presa','die','','n'],
  ...
  ['Geisel','el rehén','die','','n'],
    ['die Chemie','quí­mica','die','Chemien','n'],
    [],
  ...
  ['íœberfluss','la abundancia / el exceso','der','','n'],
  ...
  ['online','en lí­nea','','','adj'],['offline','fuera de lí­nea','','','adj'],
  ...
  ['Empathie','empatí­a','die','','n'],['Solidarität','solidaridad','die','','n'],
  ...
  ['vermissen','echar de menos','','','v'],['sehnen','anhelar','','','v'],
    ...
    ['die Technologie','tecnologí­a','die','Technologien','n'],
  ...
  ['Beliebtheit','la popularidad','die','','n'],
    [],
    ['die Geologie','geologí­a','die','Geologien','n'],
  ['Ehre','el honor','die','','n'],
  ...
  ['Inschrift','la inscripción','die','','n'],
    ['die Republik','repíºblica','die','Republiken','n'],
  ['Symbol','el sí­mbolo','das','','n'],
  ...
  ['Manuskript','el manuscrito','das','','n'],
    ['die Theorie','teorí­a','die','Theorien','n'],
  ...
  ['Engpass','el cuello de botella / estrechez','der','','n'],
    ['die Astronomie','astronomí­a','die','Astronomien','n'],
  ...
  ['Redaktion','redacción','die','Redaktionen','n'],['Artikel','artí­culo','der','Artikel','n'],
  ...
  ['Reife','la madurez','die','','n'],
    [],
    ['die Psychologie','psicologí­a','die','Psychologien','n'],
    [],
  ...
  ['Ausschuss','el comité / la comisión','der','','n'],
    ['die Philosophie','filosofí­a','die','Philosophien','n'],
  ['Belastung','la carga / el agobio','die','','n'],
  ['Kontrast','el contraste','el','','n'],
  ['Kernenergie','la energí­a nuclear','die','','n'],
  ...
  ['Das ein','la existencia / la vida','das','','n'],
    ...
    ['der Fachartikel','artí­culo especializado','der','Fachartikel','n'],
  ['Erprobung','la puesta a prueba','die','','n'],
  ['Einzelkind','el hijo íºnico','das','','n'],
    [],
  ...
  ['Fusion','la fusión','die','','n'],
    ['die Musik','míºsica','die','Musiken','n'],
  ...
  ['empirisch','empí­rico','','','adj'],['theoretisch','teórico','','','adj'],
  ...
  ['íœberschuss','el excedente / superávit','der','','n'],
  ...
  ['Psychologie','la psicologí­a','die','','n'],
  ...
  ['Privatsphäre','privacidad','die','','n'],['íœberwachung','vigilancia','die','íœberwachungen','n'],
  ...
  ['Höhepunkt','el punto culminante / clí­max','der','','n'],
  ...
  ['Anführer','el cabecilla / lí­der','der','','n'],
  ...
  ['Erzeugnis','el producto','die','','n'],
    ['die Kritik','crí­tica','die','Kritiken','n'],
  ...
  ['Fachkraft','el personal especializado','die','','n'],
    ['die Physik','fí­sica','die','Physiken','n'],
  ['Interpretation','la interpretación','die','','n'],
    ['unglaubwürdig','increí­ble','-','-','adj'],
  ...
  ['Protokoll','el protocolo','das','','n'],
    ['la Psicologí­a','la psicologí­a','','','n'],
  ['Rangordnung','la jerarquí­a','die','','n'],
  ...
  ['Rückgang','el retroceso','der','','n'],
    ...
    ['der Film','pelí­cula','der','Filme','n'],
  ...
  ['íœbergang','la transición / el paso','der','','n'],
  ...
  ['íœbereinstimmung','la concordancia / acuerdo','die','','n'],
    [],
    [],
    ['der Präsident','presidente','der','Präsidenten','n'],
    ['die Philosophie','die filosofí­a','','','n'],
  ...
  ['subjektiv','subjetivo','','','adj'],['tendenziös','tendencioso','','','adj'],
    ['die Fotografie','fotografí­a','die','Fotografien','n'],
    [],
  ...
  ['Impfstoff','la vacuna (sustancia)','der','','n'],
    ['das Publikum','píºblico','das','Publikume','n'],
  ['Quote','la cuota / el í­ndice','die','','n'],
  ...
  ['Akteur','el actor / protagonista (social/polí­tico)','der','','n'],
  ...
  ['systematisch','sistemático','','','adj'],['analytisch','analí­tico','','','adj'],
  ...
  ['Droge','la droga','die','','n'],
    ['die í–konomie','economí­a','die','í–konomien','n'],
  ...
  ['Anreiz','el incentivo / estí­mulo','der','','n'],
  ...
  ['Währung','la moneda / divisa','die','','n'],
    ...
    ['die Geige','violí­n','die','Geigen','n'],
    [],
  ...
  ['undurchführbar','inviable','','','adj'],
    [],
  ['Entdeckung','descubrimiento','die','Entdeckungen','n'],['Theorie','teorí­a','die','Theorien','n'],
  ...
  ['íœberprüfung','la comprobación / revisión','die','','n'],
...
addLevel('C1.1',[
  ...
  ['Gewährleistung','la garantí­a legal / saneamiento','die','','n'],
  ...
  ['Kategorie','la categorí­a','die','','n'],
    ['die Selbstkritik','autocrí­tica','die','Selbstkritiken','n'],
  ...
  ['Positionierung','el posicionamiento','die','','n'],
    ['die íœberzeugung','convicción','die','íœberzeugungen','n'],
  ...
  ['Praxisnähe','el enfoque práctico / cercaní­a a la realidad','die','','n'],
  ...
  ['Verknüpfung','el ví­nculo / nexo / enlace','die','','n'],
  ...
  ['Effektivität','la efectividad','die','','n'],
    ['die Synthese','sí­ntesis','die','Synthesen','n'],
  ...
  ['Leitlinie','la directriz / lí­nea guí­a','die','','n'],
  ...
  ['Neutralität','la neutralidad','die','','n'],
    ['die Ideologie','ideologí­a','die','Ideologien','n'],
  ...
  ['selbstkritisch','autocrí­tico','','','adj'],
  ...
  ['Souveränität','la soberaní­a / superioridad','die','','n'],
  ['faktisch','fáctico','','','adj'],
  ['Pragmatik','la pragmática','die','','n'],
  ['implizit','implí­cito','','','adj'],
  ...
  ['Synthese','sí­ntesis','die','Synthesen','n'],['Paradigma','paradigma','das','Paradigmen','n'],
  ...
  ['zumal','más aíºn cuando','','','conj'],['umso mehr als','tanto más cuanto','','','conj'],
  ['Zuwanderung','la inmigración','die','','n'],
  ['Schwelle','el umbral / lí­mite','die','','n'],
  ['bereichern','enriquecer','','','v'],
  ['Systematik','la sistemática / método','die','','n'],
  ['Herangehensweise','el enfoque / planteamiento / metodologí­a','die','','n'],
  ['hintergründig','profundo','','','adj'],
  ['trotzdem','a pesar de todo','','','adv'],['gleichwohl','aun así­','','','adv'],
  ['Zivilcourage','el valor cí­vico','die','','n'],
  ...
  ['Hauptmerkmal','la caracterí­stica principal','das','','n'],
  ...
  ['Anregung','la sugerencia / estí­mulo','die','','n'],
  ...
  ['Validität','la validez (cientí­fica/lógica)','die','','n'],
  ...
  ['Methodik','la metodologí­a','die','','n'],
  ...
  ['Anteilnahme','la condolencia / interés / empatí­a','die','','n'],
...
addLevel('C1.2',[
  ...
  ['substituieren','sustituir','','','v'],
    ...
    ['die Biometrie','biometrí­a','die','Biometrien','n'],
  ...
  ['Periode','perí­odo','die','Perioden','n'],
    ['dem','dem','','','n'],
  ...
  ['generell','general','','','adj'],['typisch','tí­pico','','','adj'],
  ...
  ['systematisieren','sistematizar','','','v'],['strukturieren','estructurar','','','v'],
    ...
    ['das í–kosystem','ecosistema','das','í–kosysteme','n'],
    ['mich','mich','','','n'],
    ['fährt','fährt','','','n'],
  ['justieren','ajustar','','','v'],
    ['eine','eine','','','n'],
  ...
  ['í„quivalenz','equivalencia','die','í„quivalenzen','n'],
    ['mütter','mütter','','','n'],
  ...
  ['priorisieren','priorizar','','','v'],
    ['die Nanotechnologie','nanotecnologí­a','die','Nanotechnologien','n'],
    ['die Kryptographie','criptografí­a','die','Kryptographien','n'],
  ...
  ['vorbildlich','ejemplar','','','adj'],
    ['das KritischeDenken','pensamiento crí­tico','das','KritischesDenken','n'],
    ['wann','wann','','','n'],
    ['das Szenario','escenario','das','Szenarien','n'],
    ['sich erholen','descansar / recuperarse','','','n'],
  ['Ideologie','ideologí­a','die','Ideologien','n'],
  ...
  ['kooperieren','cooperar','','','v'],['kommunizieren','comunicar','','','v'],
    ['warst','warst','','','n'],
  ['synthetisch','sintético','','','adj'],['analytisch','analí­tico','','','adj'],
    ['unser','unser','','','n'],
    ['hemmen','inhibir','','','v'],
    ['die Zertifizierung','certificación','die','Zertifizierungen','n'],
  ['Analogie','analogí­a','die','Analogien','n'],
  ...
  ['Strukturierung','estructuración','die','Strukturierungen','n'],['Organisation','organización','die','Organisationen','n'],
    ['leugnen','negar','','','v'],
    ['die Statistik','estadí­stica','die','Statistiken','n'],
  ...
  ['isolieren','aislar','','','v'],
    ...
    [],
  ['Zeitraum','perí­odo','der','Zeiträume','n'],
    ['kannst','kannst','','','n'],
    [],
  ...
  ['charakteristisch','caracterí­stico','','','adj'],['repräsentativ','representativo','','','adj'],
    ['uma','uma','','','n'],
  ...
  ['infrage stellen','poner en duda','','','v'],
    ...
    ['hueco','hueco','','','n'],
  ['konkret','concreto','','','adj'],['spezifisch','especí­fico','','','adj'],
    ['eure','eure','','','n'],
