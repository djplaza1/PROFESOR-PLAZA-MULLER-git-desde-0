...
// Palabras Ãºnicas deduplicadas: primera aparición tiene prioridad
(function(R) {
...
addLevel('A1.2',[
  ...
  ['schwer','pesado/difÃ­cil','','','adj'],['leicht','ligero/fácil','','','adj'],
  ...
  ['Einbahnstraße','dirección Ãºnica','die','Einbahnstraßen','n'],
...
addLevel('A2.1',[
  ...
  ['vermieten','alquilar','','','v'],['wechseln','cambiar','','','v'],
    ['Ãœbersetzung','traducción','die','Ãœbersetzungen','n'],
  ...
  ['Enkel','el nieto','der','','n'],
    ['fallen','caer','-','-','v'],
  ['Leitung','la dirección / tuberÃ­a / lÃ­nea','die','','n'],
...
addLevel('A2.2',[
  ...
  ['Gedächtnis','memoria','das','Gedächtnisse','n'],
    ['Bluthochdruck','hipertensión','der','-','n'],
  ...
  ['Petition','petición','die','Petitionen','n'],
    ['Reha','rehabilitación','die','Rehas','n'],
  ...
  ['Vermietung','el alquiler (acción)','die','','n'],
    ['Entzündung','inflamación','die','Entzündungen','n'],
  ...
  ['Schaf','la oveja','das','','n'],
    ...
    ['besetzt','ocupado','','','adj'],
    ['Spritze','inyección','die','Spritzen','n'],
  ...
  ['Schluss','el final / conclusión','der','','n'],
    ['Mailbox','buzón de voz','die','Mailboxen','n'],
  ...
  ['Pflegeversicherung','seguro de dependencia','die','Pflegeversicherungen','n'],
    ['Untersuchung','revisión','die','Untersuchungen','n'],
  ...
  ['erinnern','recordar','','','v'],
    ...
    ['der BotanischerGarten','jardÃ­n botánico','der','BotanischeGärten','n'],
  ...
  ['Adresse','dirección','die','Adressen','n'],['Telefonnummer','nÃºmero teléfono','die','Telefonnummern','n'],
  ...
  ['Schlag','el golpe','der','','n'],
    ['Handynummer','nÃºmero de móvil','die','Handynummern','n'],
  ...
  ['Hypothek','hipoteca','die','Hypotheken','n'],
    ...
    ['Lärmbelästigung','contaminación acÃºstica','die','Lärmbelästigungen','n'],
...
addLevel('B1.1',[
  ...
  ['Vernunft','la razón / el sentido comÃºn','die','','n'],
  ...
  ['Eis','el helado / hielo','das','','n'],
    ['Präsentation','presentación','die','Präsentationen','n'],
  ...
  ['Stift','el bolÃ­grafo / el lápiz','der','','n'],
    ['einhalten','cumplir','','','v'],
  ...
  ['Phantasie','la fantasÃ­a / la imaginación','die','','n'],
    ['egal','igual','-','-','adj'],
  ...
  ['der Arbeitgeber','el empleador','der','Arbeitgeber','n'],
    ['Meeting','reunión','das','Meetings','n'],
...
addLevel('B1.2',[
  ...
  ['erlauben','permitir','','','v'],
    ['Naturschutz','protección de la naturaleza','der','-','n'],
  ...
  ['verhandeln','negociar','','','v'],
    ...
    ['Artenschutz','protección de especies','der','-','n'],
  ...
  ['zunächst','primero','','','adv'],
    ...
    ['Klimawandel','cambio climático','der','-','n'],
    ['teils','en parte','-','-','adv'],
    ['gelangweilt','aburrido','-','-','adj'],
    ['der Tornado','tornado','der','Tornados','n'],
    ['Windkraft','energÃ­a eólica','die','-','n'],
  ...
  ['Leben','la vida','das','','n'],
    ...
    ['Wasserkraft','energÃ­a hidráulica','die','-','n'],
  ...
  ['Ursache','causa','die','Ursachen','n'],['Wirkung','efecto','die','Wirkungen','n'],
    ...
    ['E-Mail','correo electrónico','die','E-Mails','n'],
  ...
  ['bereits','ya','','','adv'],
    ...
    ['Abfalltrennung','separación de residuos','die','-','n'],
    ['Müllverbrennung','incineración de residuos','die','-','n'],
  ['damals','entonces','','','adv'],
  ...
  ['Anleitung','la instrucción / guÃ­a','die','','n'],
  ...
  ['Misserfolg','fracaso','der','Misserfolge','n'],
    ...
    ['Solaranlage','instalación solar','die','Solaranlagen','n'],
  ...
  ['abstimmen','votar','','','v'],['zuhören','escuchar','','','v'],
    ['Wasserverschmutzung','contaminación del agua','die','-','n'],
  ...
  ['Verbindung','la conexión','die','','n'],
    ...
    ['Mikrofon','micrófono','das','Mikrofone','n'],
  ...
  ['sich verhalten','comportarse','','','v'],
    ...
    ['Sanierung','rehabilitación','die','Sanierungen','n'],
  ...
  ['Lebensgeschichte','historia de vida','die','Lebensgeschichten','n'],
    ['Kohlendioxid','dióxido de carbono','das','-','n'],
    ['ablehnen','rechazar','-','-','v'],
...
addLevel('B2.1',[
  ...
  ['Windenergie','energÃ­a eólica','die','','n'],['Kernkraft','energÃ­a nuclear','die','Kernkräfte','n'],
  ...
  ['Ãœberlegung','la reflexión','die','','n'],
  ...
  ['Ãœberzeugung','la convicción','die','','n'],
  ...
  ['Gunst','el favor / la benevolencia','die','','n'],
    ['Illusion','die ilusión / die espejismo','','','n'],
    [],
    [],
  ...
  ['Illusion','la ilusión / el espejismo','die','Illusionen','n'],
    [],
  ...
  ['Nation','la nación','die','Nationen','n'],
  ...
  ['Dienstleistung','el servicio (económico)','die','Dienstleistungen','n'],
  ...
  ['Gestein','la roca / el mineral','das','','n'],
    ['Steuererklärung','declaración de la renta','die','Steuererklärungen','n'],
...
addLevel('B2.2',[
  ...
  ['Ãœbersicht','visión general','die','Ãœbersichten','n'],
  ...
  ['Redaktion','redacción','die','Redaktionen','n'],['Artikel','artÃ­culo','der','Artikel','n'],
  ...
  ['empirisch','empÃ­rico','','','adj'],['theoretisch','teórico','','','adj'],
  ...
  ['Ãœberschuss','el excedente / superávit','der','','n'],
  ...
  ['Ãœbergang','la transición / el paso','der','','n'],
  ...
  ['systematisch','sistemático','','','adj'],['analytisch','analÃ­tico','','','adj'],
  ...
  ['Ãœberprüfung','la comprobación / revisión','die','','n'],
...
addLevel('C1.1',[
  ...
  ['Positionierung','el posicionamiento','die','','n'],
    ['die Ãœberzeugung','convicción','die','Ãœberzeugungen','n'],
  ...
  ['Praxisnähe','el enfoque práctico / cercanÃ­a a la realidad','die','','n'],
  ...
  ['zumal','más aÃºn cuando','','','conj'],['umso mehr als','tanto más cuanto','','','conj'],
  ...
  ['Validität','la validez (cientÃ­fica/lógica)','die','','n'],
