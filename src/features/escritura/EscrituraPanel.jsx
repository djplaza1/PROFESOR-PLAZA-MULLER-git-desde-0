...
window.Muller.Panels.EscrituraPanel = function EscrituraPanel({ session }) {
  ...
  // L�neas del guion para modo guion
  ...
  return React.createElement('div', {
    ...
    React.createElement('p', { className: 'text-stone-300/95 text-xs md:text-sm mb-4 leading-relaxed border-b border-white/10 pb-3' },
      ...
      React.createElement('strong', { className: 'text-white' }, 'tableta con l�piz'),
      '. El lienzo usa ',
    ...
    React.createElement('div', { className: 'flex flex-wrap gap-1.5 md:gap-2 mb-4' },
      [
        ...
        { id: 'copy', label: 'Copia', sub: 'caligraf�a' },
        { id: 'dictation', label: 'Dictado', sub: 'o�r y escribir' },
        { id: 'prompt', label: 'Tema', sub: 'redacci�n' },
        { id: 'telc', label: 'TELC', sub: 'carta/email examen' },
        { id: 'letters', label: 'Letras DE', sub: '����' },
    ...
    spellErrors.length > 0 && React.createElement('div', { className: 'mt-4 rounded-xl bg-black/35 border border-amber-500/30 p-3' },
      React.createElement('p', { className: 'text-amber-200/90 text-sm font-bold mb-2' }, '?? Resultados de correcci�n'),
    ...
    telcCoachResult && React.createElement('div', { className: 'mt-4 rounded-xl bg-black/35 border border-emerald-500/30 p-3 space-y-2' },
      ...
      React.createElement('div', { className: 'grid grid-cols-2 md:grid-cols-4 gap-2' },
        [
          ...
          { label: 'Cohesi�n', score: telcCoachResult.scoreCohesion },
          { label: 'Gram�tica', score: telcCoachResult.scoreGrammar }
        ].map(item =>
...
// Asignar alias min�scula para PanelRouter (busca window.Muller.Panels[tab])
window.Muller.Panels.escritura = window.Muller.Panels.EscrituraPanel;

// --- Funci�n helper para renderizar el contenido de cada modo ---
  ...
  switch (mode) {
    case 'free':
      return React.createElement('div', { className: 'mb-4 rounded-xl bg-black/35 border border-rose-500/25 p-3' },
        React.createElement('p', { className: 'text-rose-200/90 text-sm font-bold' }, 'P�gina en blanco'),
    ...
    case 'copy':
      return React.createElement('div', { className: 'mb-4 rounded-xl bg-black/35 border border-rose-500/25 p-3 space-y-2' },
        React.createElement('p', { className: 'text-rose-200/90 text-sm font-bold' }, 'Copia la frase (caligraf�a alemana)'),
    ...
    case 'dictation':
      return React.createElement('div', { className: 'mb-4 rounded-xl bg-black/35 border border-rose-500/25 p-3 space-y-3' },
        React.createElement('p', { className: 'text-rose-200/90 text-sm font-bold' }, 'Dictado alem�n'),
        ...
        React.createElement('p', { className: 'text-[10px]' }, `�tem ${Math.min(writingDictIdx+1, writingDictationPool.length)} de ${writingDictationPool.length}`),
    ...
    case 'prompt':
      return React.createElement('div', { className: 'mb-4 rounded-xl bg-black/35 border border-rose-500/25 p-3 space-y-2' },
        React.createElement('p', { className: 'text-rose-200/90 text-sm font-bold' }, 'Tema para redacci�n corta'),
    ...
    case 'guion':
      return React.createElement('div', { className: 'mb-4 rounded-xl bg-black/35 border border-rose-500/25 p-3 space-y-2' },
        React.createElement('p', { className: 'text-rose-200/90 text-sm font-bold' }, 'Escribe l�neas de la historia'),
        guionLines.length > 0
