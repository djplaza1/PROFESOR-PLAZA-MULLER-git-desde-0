...
<table>
  ...
  <tr><td>man + aktiv</td><td>se + verbo</td><td>Man sagt, dass...</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Das kann gemacht werden. → Das ___ ___ machen.", respuesta: "lässt sich", opciones: null, traduccion: "Eso se puede hacer.", pista: "sich lassen + Infinitiv", explicacion: "lässt sich = sustituye a 'kann gemacht werden'." },
        { tipo: "opcion", frase: "Das kann man lesen. → Das ist ___ .", respuesta: "lesbar", opciones: ["lesbar", "leserlich", "lesend", "gelesen"], traduccion: "Se puede leer. → Es legible.", pista: null, explicacion: "lesbar = adjetivo en -bar (posibilidad pasiva)." },
        { tipo: "hueco", frase: "Das muss beachtet werden. → Das ___ ___ beachten.", respuesta: "ist zu", opciones: null, traduccion: "Eso debe ser tenido en cuenta.", pista: "obligación pasiva", explicacion: "ist zu beachten = sein + zu + Infinitiv (obligación)." },
        { tipo: "opcion", frase: "Das kann man erklären. → Das ___ sich ___ .", respuesta: "lässt erklären", opciones: ["lässt erklären", "erklärt sich", "ist erklärbar", "man erklärt"], traduccion: "Eso se puede explicar.", pista: null, explicacion: "lässt sich erklären = posibilidad pasiva con sich lassen." },
        { tipo: "hueco", frase: "Dieser Vorschlag ___ sich umsetzen.", respuesta: "lässt", opciones: null, traduccion: "Esta propuesta se puede implementar.", pista: "sich lassen conjugado", explicacion: "lässt sich umsetzen = es realizable." },
        ...
        { tipo: "hueco", frase: "___ kann das nicht machen.", respuesta: "Man", opciones: null, traduccion: "No se puede hacer eso.", pista: "sujeto impersonal", explicacion: "man + Aktiv = alternativa coloquial a la pasiva." },
        ...
        { tipo: "hueco", frase: "Die Maschine ___ sich reparieren.", respuesta: "lässt", opciones: null, traduccion: "La máquina se puede reparar.", pista: "sich lassen 3ª sg", explicacion: "lässt sich reparieren = es reparable." },
        ...
        { tipo: "hueco", frase: "____ hört oft, dass es teuer ist.", respuesta: "Man", opciones: null, traduccion: "Se oye a menudo que es caro.", pista: "sujeto impersonal", explicacion: "man + hört = alternativa coloquial a 'es wird gehört'." },
...
<table>
  ...
  <tr><td>ohne dass</td><td>sin que</td><td>Er ging, ohne dass er sich verabschiedete.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Man spart Zeit, ___ man das Auto nimmt.", respuesta: "indem", opciones: null, traduccion: "Se ahorra tiempo tomando el coche.", pista: "conector modal", explicacion: "indem = mediante/al + Infinitivo." },
        ...
        { tipo: "hueco", frase: "___ er arbeitet, schläft er.", respuesta: "Statt dass", opciones: null, traduccion: "En lugar de trabajar, duerme.", pista: "sustitución", explicacion: "Statt dass = en lugar de (contrariedad)." },
        ...
        { tipo: "hueco", frase: "___ du regelmäßig übst, wirst du besser.", respuesta: "Indem", opciones: null, traduccion: "Practicando regularmente mejorarás.", pista: "conector modal al inicio", explicacion: "Indem + Nebensatz = método/medio." },
        ...
        { tipo: "hueco", frase: "___ er hilft, stört er.", respuesta: "Statt dass", opciones: null, traduccion: "En lugar de ayudar, molesta.", pista: "oposición", explicacion: "Statt dass = expresión de sustitución frustrada." },
        ...
        { tipo: "hueco", frase: "___ man die Regeln wiederholt, festigt man das Wissen.", respuesta: "Indem", opciones: null, traduccion: "Repitiendo las reglas se consolida el conocimiento.", pista: "método/medio", explicacion: "Indem + Nebensatz = describe el método." },
        ...
        { tipo: "hueco", frase: "___ er rechtzeitig kam, verspätete er sich.", respuesta: "Statt dass", opciones: null, traduccion: "En lugar de llegar a tiempo, llegó tarde.", pista: "expectativa no cumplida", explicacion: "Statt dass + Nebensatz = contraexpectativa." },
...
<table>
  ...
  <tr><td>nichtsdestotrotz</td><td>no obstante</td><td>0 / 1</td><td>Nichtsdestotrotz bleiben wir optimistisch.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Es war anstrengend, ___ haben wir es geschafft.", respuesta: "allerdings", opciones: null, traduccion: "Fue agotador, sin embargo lo logramos.", pista: "conector concesivo", explicacion: "allerdings = sin embargo (concesivo formal)." },
        { tipo: "opcion", frase: "Es war kalt, ___ gingen wir schwimmen.", respuesta: "dennoch", opciones: ["dennoch", "trotzdem", "allerdings", "hingegen"], traduccion: "Hacía frío, no obstante fuimos a nadar.", pista: null, explicacion: "dennoch = no obstante (más formal que trotzdem)." },
        { tipo: "hueco", frase: "Er spricht wenig, sie ___ sehr viel.", respuesta: "hingegen", opciones: null, traduccion: "Él habla poco, ella en cambio mucho.", pista: "contraste", explicacion: "hingegen = en cambio (contraste entre sujetos)." },
        { tipo: "opcion", frase: "___ bleiben wir zuversichtlich.", respuesta: "Nichtsdestotrotz", opciones: ["Nichtsdestotrotz", "Trotzdem", "Allerdings", "Hingegen"], traduccion: "No obstante, seguimos siendo optimistas.", pista: null, explicacion: "Nichtsdestotrotz = forma enfática de 'no obstante'." },
        { tipo: "hueco", frase: "___ du mitmachst, bin ich dabei.", respuesta: "Insofern", opciones: null, traduccion: "En la medida en que participes, yo estoy dentro.", pista: "condición formal", explicacion: "Insofern = en la medida en que (condicional formal)." },
        ...
        { tipo: "hueco", frase: "Es war teuer, ___ sehr gut.", respuesta: "allerdings", opciones: null, traduccion: "Era caro, pero sin embargo muy bueno.", pista: "concesión", explicacion: "allerdings = matiz concesivo en segunda posición." },
        ...
        { tipo: "hueco", frase: "Die Arbeit war hart, ___ sind wir zufrieden.", respuesta: "nichtsdestotrotz", opciones: null, traduccion: "El trabajo fue duro, no obstante estamos satisfechos.", pista: "énfasis formal", explicacion: "nichtsdestotrotz = conector formal enfático." },
        ...
        { tipo: "hueco", frase: "Das ist nicht schlecht, ___ sogar sehr gut.", respuesta: "vielmehr", opciones: null, traduccion: "Eso no es malo, sino más bien muy bueno.", pista: "rectificación", explicacion: "vielmehr = introduce una corrección o matiz." },
...
<table>
  ...
  <tr><td>miß-</td><td>verstehen</td><td>mißverstehen</td><td>malinterpretar</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Ich ___ deine Frage morgen.", respuesta: "beantworte", opciones: null, traduccion: "Responderé a tu pregunta mañana.", pista: "be- + antworten", explicacion: "beantworten = antworten + be- (transitivo/respuesta concreta)." },
        { tipo: "opcion", frase: "Er ___ sein Haus.", respuesta: "verkauft", opciones: ["verkauft", "verkaufen", "kaufen", "kaufte"], traduccion: "Él vende su casa.", pista: null, explicacion: "verkaufen = kaufen + ver- (cambio de posesión)." },
        { tipo: "hueco", frase: "Das Glas ___ auf dem Boden.", respuesta: "zerbrach", opciones: null, traduccion: "El vaso se hizo pedazos en el suelo.", pista: "pretérito + zer-", explicacion: "zerbrechen = brechen + zer- (destrucción total)." },
        { tipo: "opcion", frase: "Wir ___ den Müll.", respuesta: "entfernen", opciones: ["entfernen", "fernen", "entfernen", "fernen weg"], traduccion: "Retiramos la basura.", pista: null, explicacion: "entfernen = fernen + ent- (separación/eliminación)." },
        { tipo: "hueco", frase: "Ich ___ ein Paket.", respuesta: "empfange", opciones: null, traduccion: "Recibo un paquete.", pista: "emp- + fangen", explicacion: "empfangen = fangen + emp- (recibir/atrapar simbólico)." },
        { tipo: "opcion", frase: "Ich habe das leider ___.", respuesta: "mißverstanden", opciones: ["mißverstanden", "verstanden", "vermißstanden", "mißstehen"], traduccion: "Lamentablemente lo malinterpreté.", pista: null, explicacion: "mißverstehen = verstehen + miß- (malentender/error)." },
        { tipo: "hueco", frase: "Er ___ die Rechnung.", respuesta: "bezahlt", opciones: null, traduccion: "Él paga la factura.", pista: "be- + zahlen", explicacion: "bezahlen = zahlen + be- (pagar algo concreto)." },
        { tipo: "opcion", frase: "Die Blume ___ im Frühling.", respuesta: "erblüht", opciones: ["erblüht", "blüht", "verblüht", "geblüht"], traduccion: "La flor florece en primavera.", pista: null, explicacion: "erblühen = blühen + er- (inicio del proceso)." },
        { tipo: "hueco", frase: "Die Feinde ___ die Ruhe.", respuesta: "zerstören", opciones: null, traduccion: "Los enemigos destruyen la paz.", pista: "zer- + stören", explicacion: "zerstören = stören + zer- (destrucción intensiva)." },
        { tipo: "opcion", frase: "Er ___ das Bett.", respuesta: "entdeckt", opciones: ["entdeckt", "deckt", "entdeckt", "deckt zu"], traduccion: "Él descubre la cama / descubre algo.", pista: null, explicacion: "entdecken = decken + ent- (descubrir/revelar)." },
        { tipo: "hueco", frase: "Wir ___ ihn für klug.", respuesta: "erhalten", opciones: null, traduccion: "Lo consideramos inteligente.", pista: "er- + halten", explicacion: "erhalten = halten + er- (recibir/mantener)." },
        { tipo: "opcion", frase: "___ Sie dieses Werkzeug?", respuesta: "Gebrauchen", opciones: ["Gebrauchen", "Brauchen", "Verbrauchen", "Erbrauchen"], traduccion: "¿Usa usted esta herramienta?", pista: null, explicacion: "gebrauchen = brauchen + ge- (usar/aplicar)." }
      ]
    }
  }
];