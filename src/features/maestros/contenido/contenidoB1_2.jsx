...
window.Muller.Maestros.contenido.B1_2 = [
  ...
  // ============================================================
  {
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Der ___ Hund liegt auf dem Sofa. (schlafende)", respuesta: "schlafende", opciones: null, traduccion: "El perro durmiente está en el sofá.", pista: "Partizip I de schlafen", explicacion: "schlafend + e = schlafende (declinación débil)." },
        ...
        { tipo: "hueco", frase: "Eine ___ Verkäuferin half mir. (lächelnde)", respuesta: "lächelnde", opciones: null, traduccion: "Una dependienta sonriente me ayudó.", pista: "Partizip I de lächeln", explicacion: "lächelnd + e = lächelnde, femenino Nominativ." },
        ...
        { tipo: "hueco", frase: "Der ___ Junge fiel hin. (rennende)", respuesta: "rennende", opciones: null, traduccion: "El niño corredor se cayó.", pista: "Partizip I de rennen", explicacion: "rennend + e = rennende (acción en curso)." },
        ...
        { tipo: "hueco", frase: "Die ___ Tür muss repariert werden. (geschlossene)", respuesta: "geschlossene", opciones: null, traduccion: "La puerta cerrada debe ser reparada.", pista: "Partizip II de schließen", explicacion: "geschlossen + e = geschlossene." },
        ...
        { tipo: "hueco", frase: "Die ___ Blumen sind schön. (blühenden)", respuesta: "blühenden", opciones: null, traduccion: "Las flores florecientes son hermosas.", pista: "Partizip I de blühen", explicacion: "blühend + en = blühenden (plural Dativ)." },
        ...
        { tipo: "hueco", frase: "Das ___ Kind weint laut. (weinende)", respuesta: "weinende", opciones: null, traduccion: "El niño que llora llora fuerte.", pista: "Partizip I de weinen", explicacion: "weinend + e = weinende." },
  ...
  // ============================================================
  {
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Ich kenne ___ Studenten. (den)", respuesta: "den", opciones: null, traduccion: "Conozco al estudiante.", pista: "Akkusativ masculino", explicacion: "den + Student + en = Akkusativ con N-Deklination." },
        ...
        { tipo: "hueco", frase: "Wir danken ___ Kunden. (dem)", respuesta: "dem", opciones: null, traduccion: "Agradecemos al cliente.", pista: "Dativ masculino", explicacion: "dem + Kunde + n = Dativ." },
        ...
        { tipo: "hueco", frase: "Ich sehe ___ Löwen im Zoo. (den)", respuesta: "den", opciones: null, traduccion: "Veo al león en el zoológico.", pista: "Akkusativ", explicacion: "den Löwen = Akkusativ (Löwe → Löwen)." },
        ...
        { tipo: "hueco", frase: "Die Tasche ___ Polizisten ist schwer. (des)", respuesta: "des", opciones: null, traduccion: "La bolsa del policía es pesada.", pista: "Genitiv masculino", explicacion: "des Polizisten = Genitiv (Polizist → Polizisten)." },
        ...
        { tipo: "hueco", frase: "Sie besucht ___ Prinzen im Schloss. (den)", respuesta: "den", opciones: null, traduccion: "Ella visita al príncipe en el castillo.", pista: "Akkusativ", explicacion: "den Prinzen = Akkusativ (Prinz → Prinzen)." },
        ...
        { tipo: "hueco", frase: "Er vertraut ___ Kollegen nicht. (dem)", respuesta: "dem", opciones: null, traduccion: "Él no confía en el colega.", pista: "Dativ con vertrauen", explicacion: "vertrauen + Dativ → dem Kollegen." },
  ...
  // ============================================================
  {
    ...
    ejercicioBase: {
      ...
      preguntas: [
        ...
        { tipo: "hueco", frase: "___ gehst du ___ bleibst du? (Entweder ... oder)", respuesta: "Entweder ... oder", opciones: null, traduccion: "O te vas o te quedas?", pista: "conector de alternativa", explicacion: "entweder...oder = o...o." },
        ...
        { tipo: "hueco", frase: "___ mehr man reist, ___ mehr lernt man. (Je ... desto)", respuesta: "Je ... desto", opciones: null, traduccion: "Cuanto más se viaja, más se aprende.", pista: "relación proporcional", explicacion: "je...desto = cuanto más...más." },
        ...
        { tipo: "hueco", frase: "___ du kommst ___ ich gehe. (Entweder ... oder)", respuesta: "Entweder ... oder", opciones: null, traduccion: "O vienes tú o me voy yo.", pista: "alternativa exclusiva", explicacion: "entweder...oder presenta dos opciones." },
        ...
        { tipo: "hueco", frase: "___ älter ich werde, ___ weiser bin ich. (Je ... desto)", respuesta: "Je ... desto", opciones: null, traduccion: "Cuanto mayor me hago, más sabio soy.", pista: "proporcionalidad", explicacion: "je...desto para cambios progresivos." },
        ...
        { tipo: "hueco", frase: "___ ich ___ du hast recht. (Weder ... noch)", respuesta: "Weder ... noch", opciones: null, traduccion: "Ni tú ni yo tenemos razón.", pista: "negación doble", explicacion: "weder...noch con sujetos diferentes." },
        ...
        { tipo: "hueco", frase: "___ schneller du fährst, ___ gefährlicher wird es. (Je ... desto)", respuesta: "Je ... desto", opciones: null, traduccion: "Cuanto más rápido conduces, más peligroso se vuelve.", pista: "relación causal proporcional", explicacion: "je...desto expresa consecuencia proporcional." }
      ]
    }
  },
  // ============================================================
  ...
  // ============================================================
  {
    ...
    ejercicioBase: {
      ...
      preguntas: [
        ...
        { tipo: "hueco", frase: "Sie meint, sie ___ müde. (sei)", respuesta: "sei", opciones: null, traduccion: "Ella opina que está cansada.", pista: "K.I de sein", explicacion: "sei = Konjunktiv I de sein (3ª persona)." },
        ...
        { tipo: "hueco", frase: "Die Zeitung schreibt, der Minister ___ zurück. (trete)", respuesta: "trete", opciones: null, traduccion: "El periódico escribe que el ministro dimite.", pista: "K.I de treten", explicacion: "trete = Konjunktiv I de treten (retirarse/dimitir)." },
        ...
        { tipo: "hueco", frase: "Er behauptet, er ___ Geld. (habe)", respuesta: "habe", opciones: null, traduccion: "Él afirma que tiene dinero.", pista: "K.I de haben", explicacion: "habe = K.I, usado en afirmaciones no verificadas." },
        ...
        { tipo: "hueco", frase: "Der Professor sagt, die Prüfung ___ schwer. (sei)", respuesta: "sei", opciones: null, traduccion: "El profesor dice que el examen es difícil.", pista: "K.I de sein", explicacion: "sei = estilo indirecto para 'ist'." },
        ...
        { tipo: "hueco", frase: "Er fragt, ob wir ihm ___ können. (helfen)", respuesta: "helfen", opciones: null, traduccion: "Pregunta si podemos ayudarle.", pista: "Infinitivo con können", explicacion: "können + Infinitiv = estructura modal." },
        ...
        { tipo: "hueco", frase: "Er sagt, er ___ alles verstanden. (habe)", respuesta: "habe", opciones: null, traduccion: "Él dice que lo ha entendido todo.", pista: "K.I Perfekt", explicacion: "habe + Partizip II = Perfekt en K.I." }
      ]
    }
  },
  // ============================================================
  ...
  // ============================================================
  {
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "___ des Regens bleibe ich zu Hause. (Wegen)", respuesta: "Wegen", opciones: null, traduccion: "Debido a la lluvia me quedo en casa.", pista: "preposición causal", explicacion: "wegen + Genitiv = a causa de." },
        ...
        { tipo: "hueco", frase: "___ des Lärms konnte ich nicht schlafen. (Trotz)", respuesta: "Trotz", opciones: null, traduccion: "A pesar del ruido no podía dormir.", pista: "preposición concesiva", explicacion: "trotz + Genitiv = a pesar de." },
        ...
        { tipo: "hueco", frase: "___ des Geldes kauft er ein neues Auto. (Wegen)", respuesta: "Wegen", opciones: null, traduccion: "Gracias al dinero compra un coche nuevo.", pista: "causa positiva", explicacion: "wegen + Genitiv (des Geldes)." },
        ...
        { tipo: "hueco", frase: "___ der Schule gibt es einen Sportplatz. (Außerhalb)", respuesta: "Außerhalb", opciones: null, traduccion: "Fuera de la escuela hay un campo de deportes.", pista: "preposición locativa", explicacion: "außerhalb + Genitiv = fuera de." },
        ...
        { tipo: "hueco", frase: "___ der Prüfung lernt sie viel. (Wegen)", respuesta: "Wegen", opciones: null, traduccion: "A causa del examen ella estudia mucho.", pista: "causa/examen", explicacion: "wegen der Prüfung = motivo del estudio." },
        ...
        { tipo: "hueco", frase: "___ des Parks ist ein Fluss. (Unweit)", respuesta: "Unweit", opciones: null, traduccion: "No lejos del parque hay un río.", pista: "preposición de distancia", explicacion: "unweit + Genitiv = no lejos de." },
  ...
  // ============================================================
  {
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Ich versuche, das Buch ___ lesen. (zu)", respuesta: "zu", opciones: null, traduccion: "Intento leer el libro.", pista: "Infinitiv con zu", explicacion: "versuchen + zu + Infinitiv." },
        ...
        { tipo: "hueco", frase: "Wir planen, morgen ___ fahren. (abzufahren)", respuesta: "abzufahren", opciones: null, traduccion: "Planeamos salir mañana.", pista: "verbo separable + zu", explicacion: "abzufahren = ab + zu + fahren (separable)." },
        ...
        { tipo: "hueco", frase: "Sie hat vergessen, das Fenster ___ schließen. (zu)", respuesta: "zu", opciones: null, traduccion: "Ella olvidó cerrar la ventana.", pista: "nach vergessen", explicacion: "vergessen + zu + Infinitiv." },
        ...
        { tipo: "hueco", frase: "Ich brauche nicht ___ kommen. (zu)", respuesta: "zu", opciones: null, traduccion: "No necesito venir.", pista: "brauchen + zu (negativo)", explicacion: "nicht brauchen + zu = no necesitar." },
        ...
        { tipo: "hueco", frase: "Es ist verboten, hier ___ rauchen. (zu)", respuesta: "zu", opciones: null, traduccion: "Está prohibido fumar aquí.", pista: "nach verboten", explicacion: "verboten + zu + Infinitiv." },
        ...
        { tipo: "hueco", frase: "Er begann, Deutsch ___ lernen. (zu)", respuesta: "zu", opciones: null, traduccion: "Él empezó a aprender alemán.", pista: "nach beginnen", explicacion: "beginnen + zu + Infinitiv." },
