  ...
  <tr><td>ohne...zu</td><td>sin</td><td>Er ging, ohne zu zahlen.</td><td>Er ging, ohne dass er zahlte.</td></tr>
    ...
    ejercicioBase: {
      ...
      preguntas: [
        ...
        { tipo: "hueco", frase: "Er arbeitet, ___ seine Familie reisen kann.", respuesta: "damit", opciones: null, traduccion: "Él trabaja para que su familia pueda viajar (diferente sujeto).", pista: "conjunción final con diferente sujeto", explicacion: "damit = para que (subordinada final con diferente sujeto)." },
...
<table>
  ...
  <tr><td>infolgedessen</td><td>en consecuencia</td><td>Es regnete stark, infolgedessen fiel das Fest aus.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "___, ist das Experiment gelungen.", respuesta: "Ferner", opciones: null, traduccion: "Además, el experimento ha salido bien.", pista: "conector formal 'además'", explicacion: "Ferner = además (conector formal, posición 0)." },
        { tipo: "opcion", frase: "Das ist ___ bewiesen.", respuesta: "keineswegs", opciones: ["keineswegs", "nichtsdestotrotz", "infolgedessen", "ferner"], traduccion: "Eso no está demostrado de ninguna manera.", pista: null, explicacion: "keineswegs = de ninguna manera (negación enfática formal)." },
        { tipo: "hueco", frase: "___ müssen wir weitermachen.", respuesta: "Nichtsdestotrotz", opciones: null, traduccion: "No obstante, debemos continuar.", pista: "conector concesivo enfático", explicacion: "Nichtsdestotrotz = no obstante (conector concesivo formal y enfático)." },
        { tipo: "opcion", frase: "___ der Finanzen gibt es Probleme.", respuesta: "Hinsichtlich", opciones: ["Hinsichtlich", "Infolgedessen", "Ferner", "Vielmehr"], traduccion: "En cuanto a las finanzas, hay problemas.", pista: null, explicacion: "Hinsichtlich + Genitivo = en cuanto a / con respecto a." },
        ...
        { tipo: "hueco", frase: "___ der Ergebnisse sind wir zufrieden.", respuesta: "In Bezug auf", opciones: null, traduccion: "En relación con los resultados, estamos satisfechos.", pista: "preposición formal + Akkusativ", explicacion: "In Bezug auf + Akk. = en relación con / respecto a." },
        ...
        { tipo: "hueco", frase: "Das ist ___ korrekt, sondern falsch.", respuesta: "keineswegs", opciones: null, traduccion: "Eso no es correcto de ninguna manera, sino falso.", pista: "negación enfática formal", explicacion: "keineswegs + sondern = negación enfática seguida de corrección." },
...
<table>
  ...
  <tr><td>nieder-</td><td>abajo</td><td>Die Regierung schlug den Aufstand nieder.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Er lief ihr ___.", respuesta: "hinterher", opciones: null, traduccion: "Corrió detrás de ella.", pista: "prefijo separable de 'detrás'", explicacion: "hinterher- = detrás / después (prefijo separable)." },
        { tipo: "opcion", frase: "Wir gehen der Sonne ___.", respuesta: "entgegen", opciones: ["entgegen", "hinterher", "empor", "nieder"], traduccion: "Caminamos hacia el sol.", pista: null, explicacion: "entgegen- = hacia / al encuentro de (dirección)." },
        { tipo: "hueco", frase: "Der Vogel stieg ___.", respuesta: "empor", opciones: null, traduccion: "El pájaro ascendió (hacia arriba, literario).", pista: "prefijo literario de ascenso", explicacion: "empor- = hacia arriba (literario; coloquial: hoch-)." },
        { tipo: "opcion", frase: "Sie ___ den Aufstand ___.", respuesta: "schlug nieder", opciones: ["schlug nieder", "schlug empor", "lief hinterher", "nahm vorweg"], traduccion: "Suprimieron la revuelta.", pista: null, explicacion: "niederschlagen = derribar / suprimir (connotación violenta)." },
        { tipo: "hueco", frase: "Ich möchte nichts ___ nehmen.", respuesta: "vorweg", opciones: null, traduccion: "No quiero adelantar nada.", pista: "prefijo de anticipación", explicacion: "vorwegnehmen = adelantarse a / anticipar." },
        { tipo: "opcion", frase: "Sie saß mir ___ .", respuesta: "gegenüber", opciones: ["gegenüber", "entgegen", "hinterher", "empor"], traduccion: "Estaba sentada frente a mí.", pista: null, explicacion: "gegenübersitzen = estar sentado enfrente de." },
        { tipo: "hueco", frase: "Wir gehen der Zukunft ___ .", respuesta: "entgegen", opciones: null, traduccion: "Vamos hacia el futuro.", pista: "prefijo de dirección hacia algo", explicacion: "entgegengehen = ir hacia / encarar." },
        { tipo: "opcion", frase: "Er ___ auf den Gipfel ___.", respuesta: "stieg empor", opciones: ["stieg empor", "stieg nieder", "lief hinterher", "nahm vorweg"], traduccion: "Ascendió a la cima.", pista: null, explicacion: "emporsteigen = ascender (literario)." },
        { tipo: "hueco", frase: "Der Hund lief seinem Herrn ___ .", respuesta: "hinterher", opciones: null, traduccion: "El perro corrió detrás de su dueño.", pista: "prefijo de persecución", explicacion: "hinterherlaufen = correr detrás de / perseguir." },
        ...
        { tipo: "hueco", frase: "Er kniete vor dem König ___ .", respuesta: "nieder", opciones: null, traduccion: "Se arrodilló ante el rey.", pista: "prefijo de 'hacia abajo'", explicacion: "niederknien = arrodillarse (movimiento hacia abajo)." },
        { tipo: "opcion", frase: "___ dir nichts!", respuesta: "Nimm vorweg", opciones: ["Nimm vorweg", "Geh entgegen", "Steig empor", "Knie nieder"], traduccion: "¡No te adelantes a nada!", pista: null, explicacion: "vorwegnehmen = anticipar / adelantarse." }
      ]
    }
  },
  // ============================================================
...
<table>
  ...
  <tr><td>sogar / selbst</td><td>sogar = aditivo; selbst = enfático</td><td>Er hat sogar gelacht. / Selbst er hat gelacht.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Das ist ___ interessant.", respuesta: "recht", opciones: null, traduccion: "Eso es bastante interesante (formal).", pista: "variante formal de 'bastante'", explicacion: "recht = bastante (formal; más formal que ziemlich)." },
        { tipo: "opcion", frase: "___ ich war überrascht.", respuesta: "Selbst", opciones: ["Selbst", "Sogar", "Auch", "Beinahe"], traduccion: "Incluso yo estaba sorprendido (énfasis en el sujeto).", pista: null, explicacion: "Selbst + sujeto = incluso (énfasis en que esa persona también)." },
        { tipo: "hueco", frase: "Das ist ___ möglich.", respuesta: "durchaus", opciones: null, traduccion: "Eso es absolutamente posible.", pista: "adverbio de énfasis", explicacion: "durchaus = absolutamente / perfectamente (énfasis positivo)." },
        { tipo: "opcion", frase: "___ wäre ich gestürzt.", respuesta: "Beinahe", opciones: ["Beinahe", "Fast", "Ziemlich", "Ganz"], traduccion: "Casi me caigo (literario).", pista: null, explicacion: "Beinahe = casi (formal/literario; fast es más coloquial)." },
        { tipo: "hueco", frase: "Das ist ___ gut gelungen.", respuesta: "ganz", opciones: null, traduccion: "Eso ha salido bastante bien (coloquial).", pista: "variante coloquial de 'bastante'", explicacion: "ganz = bastante (coloquial; menos formal que recht)." },
        { tipo: "opcion", frase: "Das wusste ich ___ .", respuesta: "ohnehin", opciones: ["ohnehin", "sowieso", "durchaus", "ziemlich"], traduccion: "Eso lo sabía de por sí (formal).", pista: null, explicacion: "ohnehin = de por sí / ya de antemano (formal)." },
        { tipo: "hueco", frase: "___ die Kinder haben mitgemacht.", respuesta: "Sogar", opciones: null, traduccion: "Incluso los niños participaron (aditivo).", pista: "adverbio aditivo", explicacion: "sogar = incluso (valor aditivo, modifica al verbo)." },
        { tipo: "opcion", frase: "Das mache ich ___ .", respuesta: "sowieso", opciones: ["sowieso", "ohnehin", "durchaus", "ziemlich"], traduccion: "Eso lo hago de todas formas (coloquial).", pista: null, explicacion: "sowieso = de todas formas (coloquial; ohnehin es formal)." },
        { tipo: "hueco", frase: "Die Prüfung war ___ schwer.", respuesta: "ziemlich", opciones: null, traduccion: "El examen era bastante difícil (neutral).", pista: "adverbio neutral de grado", explicacion: "ziemlich = bastante (neutral, ni formal ni coloquial)." },
        { tipo: "opcion", frase: "___ er war verwirrt.", respuesta: "Selbst", opciones: ["Selbst", "Sogar", "Auch", "Beinahe"], traduccion: "Incluso él estaba confundido (énfasis).", pista: null, explicacion: "Selbst + sujeto = inclusión enfática." },
        { tipo: "hueco", frase: "___ hätte ich den Zug verpasst.", respuesta: "Fast", opciones: null, traduccion: "Casi pierdo el tren (coloquial).", pista: "'casi' coloquial", explicacion: "Fast = casi (coloquial; beinahe es formal)." },
        { tipo: "opcion", frase: "Er hat ___ gelacht.", respuesta: "sogar", opciones: ["sogar", "selbst", "auch", "beinahe"], traduccion: "Incluso se rió (aditivo, modifica al verbo).", pista: null, explicacion: "sogar = incluso (modifica la acción verbal)." }
      ]
    }
  },
  // ============================================================
...
<table>
  ...
  <tr><td>auf dem Schlauch stehen</td><td>estar sobre la manguera</td><td>no entender / estar bloqueado</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Wir haben es ___ ___ ___ geschafft.", respuesta: "mit Ach und Krach", opciones: null, traduccion: "Lo logramos por los pelos / apenas.", pista: "expresión para 'apenas, con dificultad'", explicacion: "mit Ach und Krach = por los pelos, apenas (con mucha dificultad)." },
        { tipo: "opcion", frase: "Das Ergebnis ist ___ ___ ___ .", respuesta: "unter aller Sau", opciones: ["unter aller Sau", "ein Katzensprung", "mit Ach und Krach", "den Nagel auf den Kopf"], traduccion: "El resultado es pésimo / deplorable.", pista: null, explicacion: "unter aller Sau = pésimo, deplorable (expresión fuerte, coloquial)." },
        { tipo: "hueco", frase: "Der Chef hat ihm ___ ___ ___ .", respuesta: "den Kopf gewaschen", opciones: null, traduccion: "El jefe le echó una bronca / le lavó la cabeza.", pista: "expresión para 'regañar severamente'", explicacion: "jemandem den Kopf waschen = regañar severamente a alguien." },
        { tipo: "opcion", frase: "Deine Antwort hat ___ ___ ___ getroffen.", respuesta: "den Nagel auf den Kopf", opciones: ["den Nagel auf den Kopf", "einen Bären aufgebunden", "mit Ach und Krach", "auf dem Schlauch"], traduccion: "Tu respuesta dio en el clavo.", pista: null, explicacion: "den Nagel auf den Kopf treffen = dar en el clavo / acertar completamente." },
        ...
        { tipo: "opcion", frase: "Er hat mir einen Bären ___ .", respuesta: "aufgebunden", opciones: ["aufgebunden", "gewaschen", "getroffen", "gelegt"], traduccion: "Me tomó el pelo / me engañó.", pista: null, explicacion: "jemandem einen Bären aufbinden = tomar el pelo / engañar." },
        { tipo: "hueco", frase: "Ich stehe völlig auf dem ___ .", respuesta: "Schlauch", opciones: null, traduccion: "Estoy completamente bloqueado / no entiendo nada.", pista: "expresión para 'no entender'", explicacion: "auf dem Schlauch stehen = estar bloqueado / no entender algo." },
        { tipo: "opcion", frase: "Wir müssen uns ins ___ legen.", respuesta: "Zeug", opciones: ["Zeug", "Schlauch", "Kopf", "Bären"], traduccion: "Debemos esforzarnos al máximo.", pista: null, explicacion: "sich ins Zeug legen = esforzarse / dar el máximo." },
        ...
        { tipo: "opcion", frase: "Der Film war ___ .", respuesta: "unter aller Sau", opciones: ["unter aller Sau", "ein Katzensprung", "den Nagel auf den Kopf", "auf dem Schlauch"], traduccion: "La película era pésima.", pista: null, explicacion: "unter aller Sau = expresión coloquial fuerte para 'deplorable'." },
