...
<table>
  ...
  <tr><td>dürfen</td><td>dürfte</td><td>Das dürfte richtig sein.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Wenn ich du ___, würde ich gehen.", respuesta: "wäre", opciones: null, traduccion: "Si yo fuera tú, me iría.", pista: "Konjunktiv II de sein", explicacion: "wäre = K.II de sein." },
        ...
        { tipo: "hueco", frase: "Das ___ teuer sein.", respuesta: "dürfte", opciones: null, traduccion: "Eso probablemente es caro.", pista: "suposición cortés", explicacion: "dürfte = K.II de dürfen (probabilidad)." },
        ...
        { tipo: "hueco", frase: "Er ___ mir helfen, wenn er Zeit hätte.", respuesta: "könnte", opciones: null, traduccion: "Él podría ayudarme si tuviera tiempo.", pista: "K.II de können", explicacion: "könnte = K.II de können (condicional)." },
        ...
        { tipo: "hueco", frase: "Wir ___ gern kommen, aber wir haben keine Zeit.", respuesta: "würden", opciones: null, traduccion: "Nos gustaría venir, pero no tenemos tiempo.", pista: "K.II de werden", explicacion: "würden = K.II de werden (condicional)." },
        ...
        { tipo: "hueco", frase: "Ich ___ gern nach Berlin fahren.", respuesta: "würde", opciones: null, traduccion: "Me gustaría viajar a Berlín.", pista: "condicional cortés", explicacion: "würde + Infinitiv = K.II de cortesía." },
        ...
        { tipo: "hueco", frase: "___ du mir bitte helfen?", respuesta: "Könntest", opciones: null, traduccion: "¿Podrías ayudarme por favor?", pista: "pregunta cortés", explicacion: "Könntest = K.II de können (petición cortés)." },
...
<table>
  ...
  <tr><td>Futuro</td><td>wird + Partizip II + werden + modal</td><td>Die Arbeit wird erledigt werden müssen.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Die Tür ___ geschlossen werden.", respuesta: "muss", opciones: null, traduccion: "La puerta debe ser cerrada.", pista: "modal müssen presente", explicacion: "muss + Partizip II + werden = pasiva con modal." },
        ...
        { tipo: "hueco", frase: "Hier ___ nicht geraucht werden.", respuesta: "darf", opciones: null, traduccion: "Aquí no se puede fumar.", pista: "prohibición", explicacion: "darf + nicht + pasiva = prohibición." },
        ...
        { tipo: "hueco", frase: "Die Prüfung ___ im Juni abgelegt werden.", respuesta: "wird", opciones: null, traduccion: "El examen será realizado en junio.", pista: "Futur pasiva", explicacion: "wird + Partizip II + werden = Futur pasiva." },
        ...
        { tipo: "hueco", frase: "Die Arbeit ___ erledigt werden.", respuesta: "muss", opciones: null, traduccion: "El trabajo debe ser terminado.", pista: "obligación presente", explicacion: "muss + erledigt werden = obligación pasiva." },
        ...
        { tipo: "hueco", frase: "Die Rechnung ___ bezahlt worden sein.", respuesta: "muss", opciones: null, traduccion: "La factura debe haber sido pagada.", pista: "suposición pasada", explicacion: "muss + Partizip II + worden sein = suposición pasiva." },
        ...
        { tipo: "hueco", frase: "Die Aufgabe ___ nicht gemacht werden.", respuesta: "braucht", opciones: null, traduccion: "La tarea no necesita ser hecha.", pista: "alternativa a müssen", explicacion: "nicht brauchen = no necesitar (más coloquial)." },
...
<table>
  ...
  <tr><td>verbinden</td><td>die Verbindung</td><td>la conexión</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "___ ist wichtig für die Karriere.", respuesta: "Das Lernen", opciones: null, traduccion: "El aprendizaje es importante para la carrera.", pista: "infinitivo nominalizado", explicacion: "Das Lernen = infinitivo como sustantivo neutro." },
        { tipo: "opcion", frase: "Die ___ erfolgt um 14 Uhr.", respuesta: "Ankunft", opciones: ["Ankunft", "Ankommung", "Ankommen", "Ankunfung"], traduccion: "La llegada ocurre a las 14 h.", pista: null, explicacion: "Ankunft = nominalización irregular de ankommen." },
        { tipo: "hueco", frase: "Sein ständiges ___ nervt mich.", respuesta: "Gerede", opciones: null, traduccion: "Su constante parloteo me molesta.", pista: "prefijo Ge- + raíz", explicacion: "Gerede = Ge- + red- + -e (connotación negativa)." },
        { tipo: "opcion", frase: "Die ___ funktioniert nicht.", respuesta: "Verbindung", opciones: ["Verbindung", "Verbindung", "Verbindung", "Verbindung"], traduccion: "La conexión no funciona.", pista: null, explicacion: "Verbindung = verbinden + -ung." },
        { tipo: "hueco", frase: "___ erweitert den Horizont.", respuesta: "Das Reisen", opciones: null, traduccion: "Viajar amplía el horizonte.", pista: "infinitivo nominalizado", explicacion: "Das Reisen = infinitivo como sustantivo." },
        { tipo: "opcion", frase: "Die ___ dauert drei Jahre.", respuesta: "Ausbildung", opciones: ["Ausbildung", "Ausbilden", "Ausbildnis", "Ausbildschaft"], traduccion: "La formación dura tres años.", pista: null, explicacion: "Ausbildung = ausbilden + -ung." },
        { tipo: "hueco", frase: "Das ___ der Kinder ist laut.", respuesta: "Gelaufe", opciones: null, traduccion: "El correr de los niños es ruidoso.", pista: "Ge- + verbo", explicacion: "Gelaufe = Ge- + lauf- + -e." },
        { tipo: "opcion", frase: "Die ___ war sehr verständlich.", respuesta: "Erklärung", opciones: ["Erklärung", "Erklären", "Erkläris", "Erklärens"], traduccion: "La explicación fue muy comprensible.", pista: null, explicacion: "Erklärung = erklären + -ung." },
        { tipo: "hueco", frase: "___ ist gesund.", respuesta: "Das Schwimmen", opciones: null, traduccion: "Nadar es saludable.", pista: "infinitivo nominalizado", explicacion: "Das Schwimmen = infinitivo como sujeto." },
        { tipo: "opcion", frase: "Die ___ fällt morgen.", respuesta: "Entscheidung", opciones: ["Entscheidung", "Entscheiden", "Entscheidnis", "Entscheidschaft"], traduccion: "La decisión se toma mañana.", pista: null, explicacion: "Entscheidung = entscheiden + -ung." },
        { tipo: "hueco", frase: "Sein ___ war sichtbar.", respuesta: "Zittern", opciones: null, traduccion: "Su temblor era visible.", pista: "infinitivo como sustantivo", explicacion: "das Zittern = infinitivo de zittern." },
        { tipo: "opcion", frase: "Die ___ der Stadt ist rasant.", respuesta: "Entwicklung", opciones: ["Entwicklung", "Entwickeln", "Entwickelung", "Entwickel"], traduccion: "El desarrollo de la ciudad es vertiginoso.", pista: null, explicacion: "Entwicklung = entwickeln + -ung." }
      ]
    }
  },
  // ============================================================
...
<table>
  ...
  <tr><td>Reflexivo</td><td>es + verbo reflexivo</td><td>Es handelt sich um einen Fehler.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "___ viele gute Bücher in der Bibliothek.", respuesta: "Es gibt", opciones: null, traduccion: "Hay muchos buenos libros en la biblioteca.", pista: "existencia + Acusativo", explicacion: "es gibt + Acusativo = hay/existe." },
        ...
        { tipo: "hueco", frase: "___ um ein Missverständnis.", respuesta: "Es handelt sich", opciones: null, traduccion: "Se trata de un malentendido.", pista: "verbo reflexivo", explicacion: "es handelt sich um = se trata de." },
        ...
        { tipo: "hueco", frase: "___ um deine Zukunft.", respuesta: "Es geht", opciones: null, traduccion: "Se trata de tu futuro.", pista: "es geht um = tratar de", explicacion: "es geht um = se trata de / va de." },
        ...
        { tipo: "hueco", frase: "___ kalt heute.", respuesta: "Es ist", opciones: null, traduccion: "Hace frío hoy.", pista: "tiempo atmosférico", explicacion: "Es ist + adjetivo = descripción del tiempo." },
        ...
        { tipo: "hueco", frase: "___ mich, dass du nicht gekommen bist.", respuesta: "Es ärgert", opciones: null, traduccion: "Me molesta que no hayas venido.", pista: "emoción negativa", explicacion: "Es ärgert mich = me molesta/enfada." },
        ...
        { tipo: "hueco", frase: "___ auf dich an.", respuesta: "Es kommt", opciones: null, traduccion: "Depende de ti.", pista: "es kommt auf...an", explicacion: "es kommt auf...an = depender de." },
...
<table>
  ...
  <tr><td>Adjetivo</td><td>Das Essen ist nicht gut.</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "hueco", frase: "Ich mag Kaffee ___", respuesta: "nicht", opciones: null, traduccion: "No me gusta el café.", pista: "negación del verbo", explicacion: "nicht al final = niega toda la acción." },
        ...
        { tipo: "hueco", frase: "Er kommt ___ heute, sondern morgen.", respuesta: "nicht", opciones: null, traduccion: "Él no viene hoy, sino mañana.", pista: "negar tiempo específico", explicacion: "nicht + [tiempo] = negación del elemento temporal." },
        ...
        { tipo: "hueco", frase: "Ich habe ___ genug Geld.", respuesta: "nicht", opciones: null, traduccion: "No tengo suficiente dinero.", pista: "negar cantidad", explicacion: "nicht + genug = negación de cantidad suficiente." },
        ...
        { tipo: "hueco", frase: "Sie mag ihn ___", respuesta: "nicht", opciones: null, traduccion: "Ella no le gusta él.", pista: "después de pronombre", explicacion: "pronombre + nicht = negación del verbo." },
        ...
        { tipo: "hueco", frase: "___ alle Schüler haben bestanden.", respuesta: "Nicht", opciones: null, traduccion: "No todos los alumnos aprobaron.", pista: "negar parte del sujeto", explicacion: "Nicht + alle = negación parcial." },
        ...
        { tipo: "hueco", frase: "Er kommt ___ mit dem Auto.", respuesta: "nicht", opciones: null, traduccion: "Él no viene en coche.", pista: "negar el medio", explicacion: "nicht + mit = niega el medio de transporte." },
...
<table>
  ...
  <tr><td>denn</td><td>interés</td><td>Wo warst du denn?</td></tr>
    ...
    ejercicioBase: {
      tipo: "mixto",
      preguntas: [
        { tipo: "opcion", frase: "Komm ___ her, bitte!", respuesta: "doch", opciones: ["doch", "ja", "eben", "denn"], traduccion: "¡Ven aquí, por favor!", pista: null, explicacion: "doch = partícula de insistencia/suavización." },
        { tipo: "hueco", frase: "Das ist ___ unglaublich!", respuesta: "ja", opciones: null, traduccion: "¡Esto es increíble!", pista: "evidencia/constatación", explicacion: "ja = el hablante presupone que es obvio." },
        { tipo: "opcion", frase: "Was machst du ___?", respuesta: "denn", opciones: ["denn", "doch", "eben", "schon"], traduccion: "¿Qué haces? (con interés)", pista: null, explicacion: "denn = solo en preguntas, expresa interés." },
        { tipo: "hueco", frase: "Es ist ___ nicht anders möglich.", respuesta: "eben", opciones: null, traduccion: "Simplemente no es posible de otra manera.", pista: "resignación", explicacion: "eben = resignación, así son las cosas." },
        { tipo: "opcion", frase: "Das wird ___ wieder.", respuesta: "schon", opciones: ["schon", "ja", "doch", "eben"], traduccion: "Ya se recuperará.", pista: null, explicacion: "schon = concesión optimista." },
        { tipo: "hueco", frase: "Komm ___ her!", respuesta: "mal", opciones: null, traduccion: "¡Ven aquí un momento!", pista: "suaviza el imperativo", explicacion: "mal = suaviza órdenes, coloquial." },
        { tipo: "opcion", frase: "Das stimmt ___!", respuesta: "doch", opciones: ["doch", "ja", "eben", "wohl"], traduccion: "¡Sí que es verdad!", pista: null, explicacion: "doch = rectificación/insistencia." },
        { tipo: "hueco", frase: "So ist das Leben ___.", respuesta: "eben", opciones: null, traduccion: "Así es la vida.", pista: "filosofía de vida", explicacion: "eben = aceptación de la realidad." },
        { tipo: "opcion", frase: "Was machst du ___ hier?", respuesta: "denn", opciones: ["denn", "doch", "eigentlich", "schon"], traduccion: "¿Qué haces aquí? (con sorpresa)", pista: null, explicacion: "denn = interés/sorpresa en preguntas." },
        { tipo: "hueco", frase: "Das ist ___ toll!", respuesta: "ja", opciones: null, traduccion: "¡Esto es estupendo!", pista: "constatación emocional", explicacion: "ja = énfasis en lo evidente." },
        { tipo: "opcion", frase: "Er wird ___ kommen.", respuesta: "wohl", opciones: ["wohl", "schon", "doch", "eben"], traduccion: "Seguramente vendrá.", pista: null, explicacion: "wohl = suposición/probabilidad." },
        { tipo: "hueco", frase: "Hilf ___ mal mit!", respuesta: "mir", opciones: null, traduccion: "Ayúdame un poco.", pista: "Dativ + mal coloquial", explicacion: "mal + mir = petición coloquial suave." }
      ]
    }
  }
];