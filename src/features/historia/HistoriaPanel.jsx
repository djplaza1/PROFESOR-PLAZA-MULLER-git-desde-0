...
window.Muller.Panels['historia'] = function({ session }) {
    ...
    function resaltarMarcas(texto) {
        ...
        return texto.replace(/\[([^\]]+)\]/g, function(match, contenido) {
            ...
            return `<span class="bg-yellow-400/60 text-white font-semibold px-1 rounded border-b-2 border-yellow-500/50 shadow-[0_2px_8px_rgba(250,204,21,0.35)]" title="${titleAttr}">${palabra}</span>`;
        });
    }
