...
const LessonView = ({ levelId, lessonIdx, onBack }) => {
  ...
  if (showComponent === 'podcast') return <PodcastView levelId={levelId} lessonIdx={lessonIdx} onBack={() => setShowComponent(null)} />;
  if (showComponent === 'story') return <StoryView levelId={levelId} lessonIdx={lessonIdx} onBack={() => setShowComponent(null)} />;
