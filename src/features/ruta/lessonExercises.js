    ...
    if (levelId === "A1.1" && lessonIdx === 0) {
      return {
        ...
        exercises: [
          ...
          { type: "pronounce", prompt: "Repite la frase:", phraseToPronounce: "Mein Name ist Anna.", answer: "Mein Name ist Anna.", translation: "Mi nombre es Anna." },
          ...
          { type: "pronounce", prompt: "Repite:", phraseToPronounce: "Der Tag ist schön.", answer: "Der Tag ist schön.", translation: "El día es bonito." },
          ...
          { type: "pronounce", prompt: "Repite:", phraseToPronounce: "Hallo, wie geht es dir?", answer: "Hallo, wie geht es dir?", translation: "Hola, ¿cómo estás?" }
        ],
        cumulativeReview: []
      };
    }
